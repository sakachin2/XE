...
//*******************************************************
  ...
  headerfh=fopen(Headerfname,"r");  //default \toolkt20\c\os2h\bseord.h//+vateR~
//headerfh=fopen(Headerfname,"rb");  //crlf/lf process required    //+vateR~
  if (!headerfh)
