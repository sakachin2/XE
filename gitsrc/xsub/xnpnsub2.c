...
#include <ualloc.h>
//********************
#include "xnpnsub.h"                                               //~v1.1R~
#include "xnpnsub2.h"                                              //~v1.1R~
//********************
...
//static  int Smask[MM_MAXN+1]={0,0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x100,//~v1.1R~
//                              0x200,0x400,0x800,0x1000,0x2000,0x4000,0x8000};//~v1.1R~
static  int Smask[MM_MAXN+1]={0,0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x100,//~v1.1I~
                              0x200,0x400,0x800,0x1000,0x2000,0x4000,0x8000,//~v1.1I~
                              0x10000, 0x20000, 0x40000, 0x80000,  //~v1.1I~
    	    				  0x100000,0x200000,0x400000,0x800000,0x1000000};//~v1.1I~
    ...
    {                                                              //~v101I~
      ...
      if (kk<Spospatcnt)                                           //~v104I~
        ...
        *(pospat+pos)=2;	//of /Nr                               //~v104I~
        ...
        if (maskr==Gmm_all_candidate                               //+v1.1R~
        &&  maskc==Gmm_all_candidate                               //+v1.1R~
        &&  maskb==Gmm_all_candidate)                              //+v1.1R~
	      if (kk>=Spospatcnt)                                      //~v104I~
            break;                                                 //~v101I~
