...
//*********************************
    ...
    Sfh=fopen(Spfnm,"r");                                          //+vateR~
//  Sfh=fopen(Spfnm,"rb");   crlf/lf process required              //+vateR~
    if (!Sfh)
...
void macroparmfile(char *Pfnm)
{
    ...
    FILE *fh;
//***************************
    fh=fopen(Pfnm,"r");                                            //+vateR~
//  fh=fopen(Pfnm,"rb");    crlf/lf process required               //+vateR~
    if (!fh)
