...
//  Spgfont=lnx_createfont(fontstyle,0.0);    //get font scale     //~v970R~
    ...
    UTRACEP("lnx_setupfont ww=%d,hh=%d,Sffontscale=%lf,Sfont_width_by_size=%lf,Sfont_height_by_size=%lf\n",ww,hh,Sffontscale,Sfont_width_by_size,Sfont_height_by_size);//~v970R~
}//lnx_setupfont                                                   //~v92dR~
#else  //!GTKPRINT
//=========================================================================
void lnx_setupfont(char *Pfontnm)                                  //~v92dR~
...
//*******************************                                  //~v92dI~
    ...
    UTRACEP("getfontmetrics asc=%lf,des=%lf,h=%lf,wch=%lf,wdigit=%lf,fw=%lf\n",//~v975I~
...
#endif                                                             //~v975I~
    UTRACEP("getfontmetrics out monospace=%d,w=%d,h=%d,Sffontscale=%lf=%d/%d\n",Smonospacefont,*Ppwidth,*Ppheight,Sffontscale,fw,fh);//~v975R~
    return;                                                        //~v92dI~
...
//********************************                                 //~v970I~
    UTRACEP("\ncreatelogfont hmi=%d,vmi=%d,maxcol=%d,maxline=%d,phase2sw=%d,header1len=%d\n",Phmi,Pvmi,maxcol,maxline,phase2sw,header1len);//~v970R~
...
//  Slinewidthf=(Spagewidth-(Sleftmargin+Sleftmargin+Srightmargin))>>1;//~v98jR~
    ...
    Scharwidthf=Slinewidthf/linecols;	//cell width for monospacing//~v970I~
    UTRACEP("double=%d,linecols=%d,Scharwidthf=%lf,Spagewidth=%d,Slinwidthf=%lf\n",//~v970I~//~v97cR~
    ...
    UTRACEP("lnx_createlogfont ffontsizeH=%lf,W=%lf\n",ffontsizeH,ffontsizeW);//~v970I~
...
//  			ffontsize/=Sfont_height_by_size;                   //~v970R~
      ...
      {                                                            //~v987I~
        ...
        UTRACEP("sw=%x,Sfont_width_by_size=%lf,Sfont_height_by_size=%lf,Slineheightf=%lf,fontsize=%lf\n",Sfontsizespecifiedsw,Sfont_width_by_size,Sfont_height_by_size,Slineheightf,ffontsize);//~v970I~//~v986R~
        ffontsize=PANGO_SCALE_FLOOR_DOUBLE(ffontsize);	//round down by PANGO_SCALE//~v970I~
//      ffontsize=(double)(int)ffontsize;//@@@@TEST                //~v970I~
        UTRACEP("fontsize=%lf\n",ffontsize);                       //~v970I~
        UTRACEP("floor fontsize=%lf\n",ffontsize);                   //~v970I~//~v976R~
...
{                                                                  //~v844I~
    ...
    int linecols;                                                  //~v975I~
//********************************                                 //~v844I~
    UTRACEP("createlogfont hmi=%d,vmi=%d,maxcol=%d,phase2sw=%d\n",Phmi,Pvmi,maxcol,phase2sw);            //~v951R~//~v975R~//~v970R~
    UTRACED("createlogfont header1",header1,header1len);           //~v970R~
	doublesw=(UCBITCHK(swsw3,SW3WIN2P)!=0);                        //~v904I~
	if (Phmi<0)	//maxcol parm only(no form,no cpi)                 //~v92dR~
    {                                                              //~v874I~
    ...
    UTRACEP("\nPhmi=%d,lincols=%d,Scharwidthf=%lf,Spagewidth=%d\n",//~v951R~//~v975R~//~v970R~
    ...
    UTRACEP("Pvmi=%d,maxlineparm=%d,Slineheightf=%lf,Spageheight=%d\n",//~v951R~//~v975R~
                Pvmi,maxlineparm,Slineheightf,Spageheight);//~v951R~//~v975R~
    UTRACEP("Scharwidthf=%lf,Slineheightf=%lf,scale=%lf\n",Scharwidthf,Slineheightf,Scharwidthf/Slineheightf);//~v951R~
    Sposy1st=Stopmargin;                                           //~v904I~
    UTRACEP("Sposy1st=%lf\n",Sposy1st);                            //~v951R~
    UTRACEP("lnx_createlogfont fontscale=%lf\n",Sffontscale);      //~v970I~
//fontsize set                                                     //~v92dI~
...
//            	ffontsize=(gdouble)Phmi/10/Sffontscale;            //~v92dR~//~v970R~
        ...
        UTRACEP("sw=%c,Sfont_width_by_size=%lf,Sfont_height_by_size=%lf,Slineheightf=%lf,fontsize=%lf\n",Sfontsizespecifiedsw,Sfont_width_by_size,Sfont_height_by_size,Slineheightf,ffontsize);//~v951R~//~v970R~
    ...
    UTRACEP("pangofont desc=%p dpi==%lf PANGO_SCALE=%d\n",Sppangofd,dpi,PANGO_SCALE);//~v951R~
...
//************************************                             //~v92dI~
    ...
    UTRACEP("lnx_setscale fscalex=%lf,maxcol=%d,maxline=%d,linecols=%d,widtho(%lf)/widthn(%lf)\n",fscalex,maxcol,maxline,linecols,linewidthfo,linewidthfn);//~v970R~
    ...
    UTRACEP("setscale Sfscalex=%lf,y=%lf,Scharwidth_scaled=%lf,Scharwidthf=%lf\n",Sfscalex,Sfscaley,Scharwidthf_scaled,Scharwidthf);//~v970R~
	return;                                                        //~v92dI~
}//lnx_setscale                                                    //~v970R~
#else
//===============================================================================//~v92dI~
...
//        }                                                        //~v970R~
    ...
    if (Sfscalex<1.0)                                              //~v970I~
    	Scharwidthf_scaled=Scharwidthf/Sfscalex;      //after cairo_scale//~v970I~
    UTRACEP("setscale Sfscalex=%lf,y=%lf pageheight=%d,Scharwidthf=%lf,Slinewidthf=%lf\n",Sfscalex,Sfscaley,Spageheight,Scharwidthf,Slinewidthf);//~v970R~
	return;                                                        //~v92dI~
}//lnx_setscale                                                    //~v970R~
#endif
//****************************************************************************//~v844I~
    ...
    {                                                              //~v98iI~
      ...
      {                                                            //~v98iI~
        ...
        Sbottommargin=mt;                                          //~v98iI~
                                                                   ...
                                                                   //~v98iI~
    UTRACEP("lnx_getdcinf Gformtyp=%x,Spagewidth=%d,Spageheight=%d\n",Gformtype,Spagewidth,Spageheight);//~v977I~
    UTRACEP("lnx_getdcinf margin t=%f,b=%f,l=%f,r=%f\n",Stopmargin,Sbottommargin,Sleftmargin,Srightmargin);//~v98jR~
    return;                                                        //~v970I~
}//lnx_getdcinf                                                    //~v970R~
#else  //!GTKPRINT
//=========================================================================
...
//************************************                             //~v92dI~
    if (Pfontname && *Pfontname)                                   //~v92dI~
   	...
   	UTRACEP("lnx_createfont parm == %s,size=%lf\n",pfontname,Pffontsz);//~v970R~
...
//          strcpy(fontszwk,psize);                                //~v970R~
    ...
    if (pstyle)                                                    //~v970I~
   	...
   	UTRACEP("lnx_createfont with size == %s\n",pc);                //~v970R~
    free(pparsed);                                                 //~v970I~
    pfontname=pc;                                                  //~v970I~
...
//  if (Sfontsizespecifiedsw!=1)	//no user specified size       //~v970R~
    {                                                              //~v970R~
    	...
    	UTRACEP("lnx_newpage_flush cairo_scale Sfscalex=%lf,Sfscaley=%lf\n",Sfscalex,Sfscaley);//~v970R~
	}                                                              //~v970I~
}//lnx_newpage                                                     //~v970I~
#else  //!GTKPRINT                                                 //~v970I~
//=========================================================================//~v970I~
...
{                                                                  //~v970I~
    ...
    char *pc;                                                      //~v97pI~
//*******************************                                  //~v970I~
	UTRACEP("lnx_textout2printer flag=%x\n",Pflag);                //~v970R~
...
//  swmonospace=1;//@@@@test                                       //~v970R~
    UTRACEP("lnx_textout2printer lineprefixsw=%d,swhdr0=%d,swhhex=%d\n",lineprefixsw,swhdr0,swhhex);//~v97mI~//~v97rR~
...
//  gnome_print_line_stroked(Spgpcontext,Pposx0,Pposy0,Pposx1,Pposy1);//~v92dR~//~v970R~
    ...
    UTRACEP("lnx_lineout parm=%lf,%lf-->%lf,%lf\n",Pposx0,Pposy0,Pposx1,Pposy1);//~v92hR~//~v970R~
    return;                                                        //~v92dI~
...
//  	getpapersizewh(GPS_BOTTOMLEFT,pps,&Sfmargins,&fww,&fhh);//~v986I~//~v988R~
        ...
        UTRACEP("printdialogGtkUnix settings=%p,papersize=%p=%s=%s\n",Spsettings,pps,pname,pdisplayname);//~v988R~
...
#endif                                                             //~v98nM~
//************************************                             //~v981I~
    UTRACEP("srchGtkPaperSize tid=%p\n",ugettid());                //~v984I~
	gtkinit();//for enumprinter                                    //~v981R~
    UTRACEP("lnx_srchGtkPaperSize_212 parm opt=%x,printer=%s,form=%s\n",Popt,Pprinter,Ppform);//~v984R~
...
//  formno=g_list_length(gl);                                      //~v981R~//~v9a0R~
    ...
    {                                                              //~v981R~
        ...
        UTRACEP("lnx_srchGtkPaperSize_212 name=%s=%s\n",pname,pdisplayname);//~v988R~
...
//**************************                                       //~v970I~
    ...
    UTRACEP("lnx_papersizeinit form=%s,dest=%s\n",pform,Sdest);    //~v988R~
...
//  pps=lnx_srchGtkPaperSize(SGPSO_NOSHIFT,Sdest,DEFAULT_PAPER,&SfmarginsA4);//~v977R~//~v98mR~
    ...
    UTRACEP("lnx_papersizeinit default=%s\n",gtk_paper_size_get_name(pps));//~v98mI~
...
//  SpageheightA4=gtk_paper_size_get_height(pps,GTK_UNIT_POINTS);  //~v977R~//~v9a0R~
    ...
    UTRACEP("lnx_papersizeinit default w=%lf,h=%lf\n",SpagewidthA4,SpageheightA4);//~v977R~//~v98mR~
...
//******************************                                   //~v970I~
    pango_layout_get_extents(Pplayout,&inkrect,&logicalrect);      //~v97pR~
	UTRACEP("chklayoutext inkrect x=%lf,y=%lf,w=%lf,h=%lf\n",(double)inkrect.x/PANGO_SCALE,(double)inkrect.y/PANGO_SCALE,(double)inkrect.width/PANGO_SCALE,(double)inkrect.height/PANGO_SCALE);//~v970R~
	UTRACEP("chklayoutext logrect x=%lf,y=%lf,w=%lf,h=%lf\n",(double)logicalrect.x/PANGO_SCALE,(double)logicalrect.y/PANGO_SCALE,(double)logicalrect.width/PANGO_SCALE,(double)logicalrect.height/PANGO_SCALE);//~v970R~
    if (Pprect)                                                    //~v975I~
...
//*****************************                                    //~v975I~
	UTRACEP("lnx_showlayout len=%d,ellipsize cmdlin=%d,linewidth=%lf\n",Plen,Gxpotheropt&GOO_ELLIPSIZE,Plinewidth);//~v975R~
...
//  swwrap=pango_layout_is_wrapped(Pplayout);                      //~v975M~
  ...
  {                                                                //~v97pI~
    ...
    {                                                              //~v975I~
	    ...
	    UTRACEP("lnx_showlayout rescale by scalex(%lf)=Sfscalex(%lf)*pagewidth(%lf)/layoutwidth(%lf)\n",scalex,Sfscalex,pagewidth,layoutwidth);//~v975I~
...
//  chklayoutextent(Pplayout,&logrect);                            //~v975R~
    ...
    UTRACEP("lnx_showlayout pagewidth=%lf,layoutwidth=%lf,scalex=%lf,Sfscalex=%lf\n",pagewidth,layoutwidth,scalex,Sfscalex);//~v975I~//~v97aI~
    ...
    {                                                              //~v970I~
      ...
      {                                                            //~v97pI~
    	cairo_get_matrix(Pcr,&cm);  //@@@@test                         //~v975R~//~v970R~
    	UTRACEP("after reset rescale matrix xx=%lf,yy=%lf,x0=%lf,y0=%lf,xy=%lf,yx=%lf\n",cm.xx,cm.yy,cm.x0,cm.y0,cm.xy,cm.yx);//~v975I~//~v970R~
      }                                                            //~v97pI~
    }                                                              //~v970I~
#endif                                                             //~v975I~
