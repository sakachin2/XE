...
//#ifdef W32                                                       //~v92dR~
    ...
    {                                                              //~v92fI~
      ...
      if (Sotherform)   //pagesize gotten by cups printer          //~v973I~
        ...
        UTRACEP("%s:maxcol=%d,nonumsw=%d,cpitch=%d,maxcol_index=%d\n",UTT,maxcol,nonumsw,cpitch,maxcol_index);//+v9e6R~
    }                                                              //~v92fI~
	...
	UTRACEP("%s:c1=%d,c2=%d,c3=%d,c4=%d,maxc=%d,maxl=%d\n",UTT,              //~v844R~//~v9e6R~
			colmax1,colmax2,colmax3,colmax4,maxcol,maxline);           //~v844R~//~v9e6R~
    return;                                                     //~v74lI~
}//escdefaultmax                                                   //~v844R~
//**********************************************************************
//* ESC cmd setup		v5.1a
...
//    char *chsnm;                                                 //~v879R~
//********************
    UTRACEP("%s:pmaxcol=%d,prntype=%d,cmdfile=%s\n",UTT,pmaxcol,prntyp,cmdfile);//~v9e6R~
	if (!escsw)			//v5.3a
	{					//v5.3a
		esccmdlen=0;	//v5.3a	
		return;			//v5.3a
