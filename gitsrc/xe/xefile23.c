...
#else                                                              //~va3mI~
int setattraroundvhexdataline(int Popt,UCHAR *Pdbcs,UCHAR *Pattr,int Ppos1,int Ppos2,int Pwidth,int Pcolor);//~va3mI~
#endif                                                             //~va3mI~
#ifdef W32                                                         //~va3rI~
...
//          &&  (UTF_COMBINEMODE()||OPT_ISLIGATUREON())            //~va3uR~
			&&  plh->ULHtype==ULHTDATA	//file data                //~va3jI~
              ...
              if (csrcols>=0)	//csr is not on lineno fld
              {
...
UTRACEP("previousline drawsw=%d\n",vhexdrawsw);                    //~va6xI~
            }                                                      //~va20I~
//UTRACEP("vhexdrawsw=%d,sw3=%x,sw2=%x,plhcsrlinetype=%x\n",         //~va20I~//~vafcR~
...
//              ||  (UDBCSCHK_ISUCSWIDTH0(*pcd) && !UTF_COMBINEMODE() && !OPT_ISLIGATUREON())//~vb4yR~
                ...
                if (swutf8file && UDBCSCHK_ISUCSWIDTH0(*pcd))      //~vb4yR~
                {                                                  //~vb4yR~
...
//#endif                                                           //~va3hR~//~va3mR~//~va3uR~
                ...
                if (swutf8file && UDBCSCHK_ISUCSWIDTH0(*pcd))      //~vb4yI~
                {                                                  //~vb4yI~
...
//**end of not WIN32 ****                                          //~v60vI~
    ...
    {                                                              //~va3rI~
    	if (                                                       //~va3rR~
        	...
        	setattraroundvhexdataline(0,pdatapcd0,pdatapca0,Svhexcold1,Svhexcold2,width,tabattr);//~va3mR~//~va3rR~
//        if (                                                       //~va3rR~//~va3sR~
...
//**********************************************************************//~va3mI~
#ifdef W32                                                         //~va3mI~
int setattraroundvhexdataline(int Popt,UCHAR *Pdbcs,USHORT *Pattr,int Ppos1,int Ppos2,int Pwidth,int Pcolor)//~va3mR~
#else                                                              //~va3mI~
int setattraroundvhexdataline(int Popt,UCHAR *Pdbcs,UCHAR *Pattr,int Ppos1,int Ppos2,int Pwidth,int Pcolor)//~va3mI~
#endif                                                             //~va3mI~
{                                                                  //~va3mI~
...
//  if (!UTF_COMBINEMODE() && UVIOM_NONSPACECOMBINEMODE())	//splittable or FC5//~va3rI~//~va3sR~
    ...
    {                                                              //~va3mR~
        if (!UDBCSCHK_ISUCSWIDTH0(*pcd))                           //~va3mR~
            break;                                                 //~va3mR~
        UTRACEP("setattraroundvhexdatacsrpos pos=%d\n",pos);       //~va3rI~
#ifdef W32                                                         //~va3mI~
