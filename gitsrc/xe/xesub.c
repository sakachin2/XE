//*CID://+vbByR:                              update#=  685;       //~vbByR
//************************************************************* //~5102I~
//* xesub.c                                                      //~5102R~
//************************************************************* //~5102I~
//vbBy:241129 Windows:for EOFid(0x1a) dir size or line-ctr         //~vbByI
//vbzt:240302 (BUG)crush by UTRACE parm err                        //~vbztI
...
FILE *fileopen(UCHAR *Ppfile,UCHAR *Ppopt)
{
    ...
    int rc;                                                        //~vawdI
//****************************
UTRACEP("%s:fileopen:%s,opt=%s\n",UTT,Ppfile,Ppopt);                                   //~v711I~//~vbyaR//~vbztR
#ifdef ARMXXE                                                      //~vby8I
    ...
    {                                                              //~v08qI~//~vb89I
        ...
        {                                                          //~vb89I
            ...
            {                                                      //~vb89I
		    	fh=fopen(Ppfile,Ppopt);                            //~vb89I
			    rc=errno;                                          //~vb89I
//              UTRACEP("%s:fopen fh=%p,errno=rc,fn=%s\n",UTT,fh,rc,Ppfile);//~vbyaR//~vbztR
                UTRACEP("%s:fopen fh=%p,errno=%d,fn=%s\n",UTT,fh,rc,Ppfile);//~vbztR
                if (fh)                                            //~vb89I
...
//****************************                                     //~v10rI~
    ...
    if (!(Popt & GETLC_FPATHINP))                                  //~v10rI~
        if (!(fn=filefullpath(fpath,fn,sizeof(fpath))))            //~v57DR~
            return 4;                                              //~v10rI~
//  if (!(fh=fileopen(fn,"r")))                                    //~v10rR~//~vbByR
    if (!(fh=fileopen(fn,"rb")))                                    //~v10rR~//~vbByI
        return 8;                                                  //~v10rI~
//  pul=(ULONG*)(void*)(Gfilebuff+MAXLINEDATA-5);                  //~v10rR~//~vazeR
    pul=(ULONG*)(void*)(Gfilebuff+MAXLINEDATA-sizeof(ULONG)-1);                  //~v10rR~//~vazeI
    *pul=chkval;                                                   //~v10rR~
//  while (fgets(Gfilebuff,MAXLINEDATA,fh))                        //~v10rI~//~vbByR
    while (ufgetline(0,fh,Gfilebuff,MAXLINEDATA-sizeof(ULONG)-1,0/*Ppreadlen*/,0/*Ppeolid*/)==0)                        //~v10rI~//+vbByR
    {                                                              //~v10rI~
