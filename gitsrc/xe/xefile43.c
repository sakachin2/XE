...
//************************************************************  //~5225I~
long filecidclear(PUCLIENTWE Ppcw,PUFILEH Ppfh,int Popt)              //~v06rI~
{                                                               //~5225I~
...
//      	return 4;                                              //~v43fR~
        	return -1;                                             //~v43fR~
                                                                   ...
                                                                   //~v423I~
	for (plh=UGETQTOP(&Ppfh->UFHlineque),lineno=0;plh;plh=UGETQNEXT(plh))//~5225I~
	{                                                           //~5225I~
