//*CID://+vbzUR~:                            update#=  500;        //~vbzUR~
//*************************************************************
//*xechar.c                                                     //~v04dR~
//*************************************************************
//vbzU:240419 (Bug)utf8 file vhex update, when changed part of ucs to x09(TAB) replaced to tab//~vbzUI~
...
#endif                                                             //~va1cR~
		{
//  		if (*keyindata==TABCHAR)                            //~5102I~//~vbzUR~
			if (*keyindata==TABCHAR && !swutf8data) //tab not part of ucs//+vbzUR~
			{                                                   //~5102I~
				*pc=' ';                                        //~5102I~
