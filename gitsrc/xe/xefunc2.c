...
//  buff[MAXCOLUMN]=0;                                             //~v55nI~//~v7ayR~
    ...
    {                                                              //~v55nI~
		...
		setFindStat(SFSO_EXECMD_START);	//clear -cont position     //~vbAtI~
...
//          if (rc)                                                //~v56uR~
		...
		setFindStat(SFSO_EXECMD_END);	//now reject -cont option  //~vbAtI~
    }                                                              //~v55nI~
    else                                                           //~v55nI~
    {                                                              //~v55nI~
                                                                   //~v58AI~
