//CID://+vbvWR~:     update#=  40                                  //~vbvWR~
//*************************************************************
//* xeini.c                                                     //~5528R~
//************************************************************* //~v018I~
//vbzW:240425 errmsg of ini file err by func 3270 was deleted      //~vbvWI~
...
//funcid chk                                                    //~5501I~
    UTRACEP("%s:readbuff=%s\n",UTT,Sgetsbuff);                     //~vbvqI~
    if (USTRHEADIS(Sgetsbuff,"3270-Hotkey"))                       //~vbvWI~
    {                                                              //~vbvWI~
    	UTRACEP("%s:ignore 3270-Hotkey\n",UTT);                    //~vbvWI~
        return 0;                                                  //~vbvWI~
    }                                                              //~vbvWI~
