...
//vbB2:240814 (Bug)when cv cmd with option cp1027/ENG-EXT cause invalid translation//~vbB2I~
//vbzv:240302 CV cmd;avoid errmsg of "on utf8 fil" when help (CV ?).//~vbzvI~
...
// 			uerrmsg("conv-type:{E2S|S2E|E2E|S2S|J2S|S2J|J2E|E2J|S2U|U2S|S2F|F2S|E2F|F2E|M2F|F2M|U2F|F2U|B2S|S2B|B2E|E2B|B2A|A2B|B2M|B2F|M2B|F2B|B2B|M2M|K2L|L2K|X2C}",0);//~vaacI~//~vbB3R~
// 			uerrmsg("conv-type:{E2S|S2E|E2E|S2S|J2S|S2J|J2E|E2J|S2U|U2S|S2F|F2S|E2F|F2E|M2F|F2M|U2F|F2U|B2S|S2B|B2E|E2B|B2A|A2B|B2M|B2F|M2B|F2B|B2B|M2M|X2C}",0);//~vbB3R~//~vbBhR~
   			uerrmsg("conv-type:{E2S|S2E|E2E|S2S|J2S|S2J|J2E|E2J|S2U|U2S|S2F|F2S|E2F|F2E|M2F|F2M|U2F|F2U|B2S|S2B|B2E|E2B|B2A|A2B|B2M|B2F|M2B|F2B|B2B|M2M|K2L|L2K|X2C}",0);//~vbBhI~
#else                                                              //~v90vM~//~va05I~
...
//  		uerrmsg("conv-type:{E2S|S2E|E2E|S2S|J2S|S2J|J2E|E2J|S2U|U2S|S2F|F2S|U2F|F2U|B2S|S2B|B2E|E2B|B2A|A2B|B2M|M2B|M2M|X2C}",0);//~va5WI~//~vbB3R~//~vbBhR~
			uerrmsg("conv-type:{E2S|S2E|E2E|S2S|J2S|S2J|J2E|E2J|S2U|U2S|S2F|F2S|U2F|F2U|B2S|S2B|B2A|A2B|B2M|M2B|M2M|K2L|L2K|X2C}",0);//~vbBhI~
#endif                                                             //~v90vI~//~va05I~
            return 0;                                              //~v54NR~
        }                                                          //~v54NI~
...
//          ucsopt&=~UCVUCS_NEC;  //UCS conv to IBM rgn on MS kanji//~v50pI~//~vb2DR~
        ...
        case 14: //NEC                                             //~v50pR~
            ...
            break;                                                 //~v50pI~
#ifndef DOSDOS                                                     //~v59BI~
//      case 15: //E2A     //ebcdic to ascii                       //~v51HR~//~vbBkR~
        case 15: //B2S     //ebcdic to sjis (changed E2A-->B2S by v58X)//~vbBkI~
...
//          convtype=DBCSCONV_K2L;  //euc -->jis                   //~v51JR~//~vbB3R~
//          convopt|=KANDL_K2L;                                    //~v51JI~//~vbB3R~
//          break;                                                 //~v51JI~//~vbB3I~
//          uerrmsg("K2L/L2K is not supported now",                //~vbB3I~//~vbBhR~
//                  "K2L/L2K はサポートされません");               //~vbB3I~//~vbBhR~
//    	    return 4;                                              //~vbB3I~//~vbBhR~
            convtype=DBCSCONV_K2L;  //euc -->jis                   //~vbBhI~
            convopt|=KANDL_K2L;                                    //~vbBhI~
            break;                                                 //~vbBhI~
...
//          ebcopt|=~EBC2ASC_CP290;                                //~va5VI~//~vbB2R~
            ebcopt&=~EBC2ASC_CP290;                                //~vbB2I~
          else                                                     //~va5VI~
#endif //UTF8EBCD raw ebcdic file support                          //~va5VI~
...
//*****************************                                    //~v47UI~
	UTRACEP("%s:Pconvtype=0x%04x,Pconvopt=0x%08x,Sebcopt=0x%08x\n",UTT,Pconvtype,Pconvopt,Sebcopt);//~vbBhI~
#ifndef DOSDOS                                                     //~v51qI~
...
UTRACEP("%s:maxlen=%d,maxcont=%d\n",UTT,maxlen,maxcontlen);               //~v50eI~//~vbBhR~
...
//              rc=xeebc_b2f(optb2b,Sebcopt,Sebchandle,pdataw,convlen,&putf8data,&len2);//~vaacR~//~vb2ER~
            ...
            UTRACEP("%s:E2A ebcopt=0x%08x,sipendsw=%04x\n",UTT,ebcopt,sipendsw);//~vbBhI~
...
//			rc2=ucvebc2asc(ebcopt,pdataw,0,pbuff2,convlen,Perrch,&len2);//~v58TR~//~va7FR~
            UTRACEP("%s:call ucvebc2asc_handle ebcopt=%08x\n",UTT,ebcopt);//~vbBhI~
...
//  	  	rc2=ucvebc2asc_handle(Sebcopt|socontsw,Sebchandle,pbuff,0,pbuff,cvlen,Perrch,&cvlen);	//evc->asc conv//~va7FR~//~vb2ER~
            UTRACEP("%s:call ucvebc2asc_handle Sebcopt=%08x\n",UTT,Sebcopt);//~vbBhI~
