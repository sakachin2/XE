...
//                		"注。SBCS と DBCS が混合(DBCSAR/DBCSALを試して見て下さい)");//+vbDeR~
//              rc=1;                                              //+vbDeR~
                swMix=1;                                           //~vcDeI~
            }                                                      //~v76FI~
        break;                                                     
    ...
    {                                                              //~vcDeI~
        ...
        if (swMix)                                                 //~vcDeI~
            uerrmsgcat(";Note.SBCS and DBCS mixed(try DBCSAR/DBCSAL option also.)",//+vbDeR~
               		   ";SBCS と DBCS の混合です(DBCSAR/DBCSALも試して見て下さい)");//+vbDeR~
    }                                                              //~vcDeI~
	return rc;                                                     
}//fcmdrotatemain                                                  
//**************************************************************** 
...
//*************************************                            //~v78rI~
    ...
    if (opdno>0)                                                   //~v78rI~
    {                                                              //~v78rI~
        int swReset=!stricmp(pc,"RESET");                          //~vcB1I~
...
//  	if (fcmdprofgetfnm(0,pfnm,fpath,fpathpdir,fpathext,&pathlen))//~v78HR~
        ...
        {                                                          //~v78rI~
			...
			if (fcmdprofwriterecord(pfnm,&prof))                   //~v78rI~
            	return 4;                                          //~v78rI~
          if (swReset)                                             //~vcB1I~
            uerrmsg("ProfileRecordType:%s was reset",0,            //~vcB1I~
            		pctype);                                       //~vcB1I~
          else                                                     //~vcB1I~
...
//  if (fcmdprofgetfnm(0,pfnm,fpath,fpathpdir,fpathext,&pathlen))  //~v78HR~
  ...
  if (WILDCARD(fpath))                                             //~va0rI~
    ...
    UTRACED("prof1",&prof1,sizeof(PROFILE));                       //~vcB1R~
    if (!rc1)                                                      //~va0sI~
