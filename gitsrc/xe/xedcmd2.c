...
//vbz0:230815 ARM:(vbyu & vbyw)ufullpath is not effective for iconv, so support ~/ to $HOME at dcmd2//~vbz0I~
...
#define HOMEDIR     '~'     // HOME= ~/xxx                       //~vbyuR~//~vbz0R~
...
#ifdef ARMXXE                                                      //~vbz0I~
//****************************************************************//~vbyuR~//~vbz0R~
int repfnmhome(int Popt,char *Pparm/* "~/xxx" */,char *Pfpath)   //~vbyuR~//~vbz0R~
{                                                                //~vbyuR~//~vbz0R~
    int rc=0;                                                    //~vbyuR~//~vbz0R~
    char *phome=getenv("HOME");                 //system env     //~vbyuR~//~vbz0R~
    if (phome)                                                   //~vbyuR~//~vbz0R~
    {                                                            //~vbyuR~//~vbz0R~
        sprintf(Pfpath,"%s%s",phome,Pparm+1);                    //~vbyuR~//~vbz0R~
        rc=1;   //replaced                                       //~vbyuR~//~vbz0R~
    }                                                            //~vbyuR~//~vbz0R~
    UTRACEP("%s:rc=%d,parm=%s,fpath=%s,HOME=%s\n",UTT,rc,Pparm,Pfpath,phome);//~vbyuR~//~vbz0R~
    return rc;                                                     //~vbyvI~//~vbyuR~//~vbz0R~
}                                                                //~vbyuR~//~vbz0R~
#endif                                                             //~vbz0I~
//**************************************************************** //~v77ZI~
#ifdef ARMXXE                                                      //~vbyuI~
...
#ifdef ARMXXE                                                      //~vbyuI~
       if (!strchr(Pcmd,HOMEDIR))  //no *\ nor ^*\ exist          //~vbyuR~//~vbz0R~
...
//count *\ and ^*\ length                                          //~v77yR~
    ...
    {                                                              //~v77yR~
        ...
        if ((*pc2==HOMEDIR)                                      //~vbyuR~//~vbz0R~
        &&  (*(pc2+1)=='/' || *(pc2+1)==0) // ~ or ~/             //~vbz0I~
        &&  repfnmhome(0,pc2,fpath))                             //~vbyuR~//~vbz0R~
        {                                                        //~vbyuR~//~vbz0R~
            if (strchr(fpath,' '))                               //~vbyuR~//~vbz0R~
            {                                                    //~vbyuR~//~vbz0R~
                uparseindir(0,fpath,fpath2,_MAX_PATH);           //~vbyuR~//~vbz0R~
                strcpy(fpath,fpath2);                            //~vbyuR~//~vbz0R~
            }                                                    //~vbyuR~//~vbz0R~
            len=(int)strlen(fpath)+redirectid;                   //~vbyuR~//~vbz0R~
            repcnt++;                                            //~vbyuR~//~vbz0R~
        }                                                        //~vbyuR~//~vbz0R~
        else                                                       //~v77ZI~
        if (*pc2==CURDIR                                           //~v77ZR~
...
//replace *\ and ^*\ length                                        //~v77yR~
    ...
    {                                                              //~v77yR~
        ...
        &&  repfnmhome(0,pc2,fpath))                             //~vbyuR~//~vbz0R~
        {                                                        //~vbyuR~//~vbz0R~
            if (redirectid)                                      //~vbyuR~//~vbz0R~
            {                                                    //~vbyuR~//~vbz0R~
                memcpy(pco,pc,(UINT)redirectid);                 //~vbyuR~//~vbz0R~
                pco+=redirectid;                                 //~vbyuR~//~vbz0R~
            }                                                    //~vbyuR~//~vbz0R~
            if (strchr(fpath,' '))                               //~vbyuR~//~vbz0R~
            {                                                    //~vbyuR~//~vbz0R~
                uparseindir(0,fpath,fpath2,_MAX_PATH);           //~vbyuR~//~vbz0R~
            ...
            len=(int)strlen(fpath);                              //~vbyuR~//~vbz0R~
            memcpy(pco,fpath,(UINT)len);                         //~vbyuR~//~vbz0R~
        }                                                        //~vbyuR~//~vbz0R~
        else                                                       //~vbyuI~
        if (*pc2==CURDIR                                           //~v77ZI~
		&&  repcdirShared(0,pc2,fpath))                                  //~v77ZI~
...
//      ulen2=(UINT)((ULONG)pc2-(ULONG)pc1);                    //~v05CR~//~vafkR~
        ...
        if (!*pc1 || *pc1==' ')  //not subdir                      //~vbyvR~
        {                                                          //~vbyvR~
#ifdef UNX                                                         //~vbyvR~
            if (!memcmp(*Ppout,CMD_XFG,sizeof(CMD_XFG)-1))         //~vbyvR~
#else                                                              //~vbyvR~
            if (!memicmp(*Ppout,CMD_XFG,sizeof(CMD_XFG)-1))        //~vbyvR~
#endif                                                             //~vbyvR~
            {                                                      //~vbyvR~
                uerrmsg("xfg in ::(workdir) is not allowed. Use it out of xe",//~vbyvI~//~vbyuR~//~vbyvR~
                        "::(ワークディレクトリー)内への xfg はできません。xe の外でxfg してください");//~vbyvR~
                ufree(*Ppout);                                     //~vbyuR~
...
#ifdef ARMXXE                                                      //~vc72I~
            ufile_notifyLockfile(Slockfnm);                        //~vc72I~
#endif                                                             //~vc72I~
        }                                                          //~v21fI~
//#endif                                                           //~v79PR~
...
#endif                                                                //~v06xI~
    UTRACEP("%s:Slockfnm=%s\n",UTT,Slockfnm);                      //~vbz0M~
#ifdef UNX                                                         //~v21fM~
	dcmdfresetlock2();                                             //~v21fR~
#endif                                                             //~v79PI~
    if (*Slockfnm) //I'v gotten lock SOn lock                      //~v21fI~
    {                                                              //~vbz0I~
        UTRACEP("%s:call usetlock UNLOCK fnm=%s\n",UTT,Slockfnm);      //~vbz0I~//~vc72R~
...
//**************************************************************** //~vbzJI~
//!xprint command                                                  //~vbzJI~
//*ret  :rc                                                        //~vbzJI~
//**************************************************************** //~vbzJI~
int appendHcopy(PUCLIENTWE Ppcw,PUFILEH Ppfh)                      //~vbzJI~
{                                                                  //~vbzJI~
	PULINEH plh1,plh2;                                             //~vbzJI~
    char fpath[_MAX_PATH];                                         //~vbzJI~
    int rc;                                                        //~vbzJR~
//*******************                                              //~vbzJI~
    UTRACEP("%s:fnm=%s\n",UTT,Ppfh->UFHfilename);                  //~vbzJR~
    filefullpath(fpath,DCMD_HCOPY_SAVEFNM,_MAX_PATH);              //~vbzJI~
	plh1=UGETQTOP(&Ppfh->UFHlineque);                              //~vbzJI~
	plh2=UGETQEND(&Ppfh->UFHlineque);                              //~vbzJI~
  	rc=filesave(Ppcw,FSENDSW_APPEND,Ppfh,plh1,plh2,fpath);//append then close after write//~vbzJI~
    uerrmsg("ScreenHardCopy appened to %s.",                       //~vbzJI~
            "画面ハードコピーが %s に追加されました",              //~vbzJR~
		    DCMD_HCOPY_SAVEFNM);                                   //~vbzJI~
...
//*ret  :rc                                                        //~vbzJI~
//**************************************************************** //~vbzJI~
PULINEH addSepLine(PUFILEH Ppfh,PULINEH Pplhprev)                  //~vbzJI~
{                                                                  //~vbzJI~
	UINT ulen;                                                     //~vbzJR~
	UCHAR sepline[MAXCOLUMN];                                      //~vbzJI~
	UCHAR wktime[32];                                              //~vbzJI~
    #define SZ_SEPLINE 25                                          //~vbzJR~
    PULINEH plhprev=Pplhprev,plh;                                  //~vbzJR~
    //***************                                              //~vbzJI~
    ulen=1;                                                        //~vbzJR~
    plh=filealloclh(ULHTDATA,(int)ulen);                           //~vbzJI~
    *plh->ULHdata='!';                                             //~vbzJR~
    ulen=(UINT)(plh->ULHbufflen);                                  //~vbzJR~
    plh->ULHdbcs=UALLOCC(1,ulen);                                  //~vbzJI~
    memset(plh->ULHdbcs,0,ulen);                                   //~vbzJI~
	UENQENT(UQUE_AFT,plhprev,plh);                                 //~vbzJI~
    plhprev=plh;                                                   //~vbzJI~
                                                                   //~vbzJI~
    ulen=SZ_SEPLINE;                                               //~vbzJI~
    memset(sepline,'!',ulen);                                      //~vbzJI~
    plh=filealloclh(ULHTDATA,(int)ulen);                           //~vbzJI~
    memcpy(plh->ULHdata,sepline,ulen);                             //~vbzJI~
    ulen=(UINT)(plh->ULHbufflen);                                  //~vbzJI~
    plh->ULHdbcs=UALLOCC(1,ulen);                                  //~vbzJI~
    memset(plh->ULHdbcs,0,ulen);                                   //~vbzJI~
	UENQENT(UQUE_AFT,plhprev,plh);                                 //~vbzJI~
    plhprev=plh;                                                   //~vbzJI~
                                                                   //~vbzJI~
    utimeedit("YYYY/MM/DD HH:MM:SS",wktime);                       //~vbzJR~
    sprintf(sepline,"!! %-19s !!",wktime);                         //~vbzJR~
	ulen=(UINT)strlen(sepline);                                    //~vbzMR~
    plh=filealloclh(ULHTDATA,(int)ulen);                           //~vbzJI~
    memcpy(plh->ULHdata,sepline,ulen);                             //~vbzJI~
    ulen=(UINT)plh->ULHbufflen;                                    //~vbzJI~
    plh->ULHdbcs=UALLOCC(1,ulen);                                  //~vbzJI~
    ...
    *plh->ULHdata='!';                                             //~vbzJR~
    ...
    plhprev=plh;                                                   //~vbzJI~
                                                                   //~vbzJI~
    return plhprev;                                                //~vbzJI~
}                                                                  //~vbzJI~
//**************************************************************** //~vbzJI~
//!xprint command                                                  //~vbzJI~
//*ret  :rc                                                        //~vbzJI~
//**************************************************************** //~vbzJI~
int getHcopy(PUCLIENTWE Ppcw,PUFILEH Ppfh)                         //~vbzJI~
{                                                                  //~vbzJI~
    int rc=0,row;                                   //~vbzMR~      //~vbzPR~
    PULINEH plhprev=0;                                         //~vbzJI~//~vbzPR~
#ifndef XXE                                                        //~vbApR~
    PULINEH plh;                                                   //~vbzPI~
    ...
    #endif                                                         //~vbzPI~
#else                                                              //~vbzPI~
    UCHAR *pdddata,*pdddbcs;                                       //~vbzPM~
#ifdef WXE                                                         //~vbzMI~
    UCHAR wkdata[MAXCOLUMN],wkdbcs[MAXCOLUMN];                     //~vbzMI~
#else                                                              //~vbzMI~
    int ucsctr,opt,rc2;                                            //~vbzMR~
    UWCHART wkucs[MAXCOLUMN];                                      //~vbzJI~//~vbzMM~
#endif                                                             //~vbzMI~
#endif                                                             //~vbzPI~
//*******************                                              //~vbzJI~
    UTRACEP("%s:fnm=%s,GscrHeight=%d,Gscrwidth=%d\n",UTT,Ppfh->UFHfilename,Gscrheight,Gscrwidth);                  //~vbzJR~//~vbzMR~
    plhprev=UGETQTOP(&Ppfh->UFHlineque);                           //~vbzJI~
    plhprev=addSepLine(Ppfh,plhprev);                              //~vbzJI~
    for (row=0;;row++)                                             //~vbzJI~
    {                                                              //~vbzJI~
#ifdef W32                                                         //~vbzPI~
#ifdef WXE                                                         //~vbzMI~
...
#else                                                              //~vbzMI~
//#ifdef WINCON                                                    //~vbzPR~
    	rc2=uvioGetCellData(0,row,wkucs,&ucsctr);//0:local,1:utf8,4:read err;-1:eol//~vbzJR~
        if (rc2==-1)                                               //~vbzJR~
        	break;                                                 //~vbzJI~
        if (rc2==4)                                                //~vbzJR~
        	continue;                                              //~vbzJI~
        opt=0;                                                     //~vbzJI~
        if (xeutfcvu2dd(opt,wkucs,ucsctr*sizeof(UWCHART),&pdddata,&pdddbcs,&ddlen))//~vbzJR~
        	rc++;                                                  //~vbzJI~
//#endif                                                           //~vbzPR~
#endif                                                             //~vbzMI~
#else //!W32                                                       //~vbzPI~
...
//#ifndef XXE     //TODO test                                        //~vbzPI~//~vbApR~
        plh=filealloclh(ULHTDATA,ddlen);                           //~vbzJR~
        plh->ULHlinenor=lineno++;                                  //~vbzJI~
        memcpy(plh->ULHdata,pdddata,(UINT)ddlen);                  //~vbzJR~
        plh->ULHdbcs=UALLOCC(1,(UINT)plh->ULHbufflen);             //~vbzJI~
        memcpy(plh->ULHdbcs,pdddbcs,(UINT)ddlen);                  //~vbzJR~
        if (plhprev)                                               //~vbzJI~
		    UENQENT(UQUE_AFT,plhprev,plh);                         //~vbzJI~
        else                                                       //~vbzJI~
			UENQ(UQUE_END,&Ppfh->UFHlineque,plh);                  //~vbzJR~
		plhprev=plh;                                               //~vbzJI~
//#endif                                                             //~vbzPM~//~vbApR~
    }                                                              //~vbzJI~
    if (rc)                                                        //~vbzJI~
    	uerrmsg("%d line(s) translation error",0,rc);              //~vbzJI~
    return rc;                                                     //~vbzJI~
}                                                                  //~vbzJI~
//**************************************************************** //~vbzJI~
//*ret  :rc                                                        //~vbzJI~
//**************************************************************** //~vbzJI~
int func_scrHcopy(PUCLIENTWE Ppcw)                                 //~vbzJI~
{                                                                  //~vbzJI~
	PUCLIENTWE pcw;                                                //~vbzMI~
	PUFILEH pfh;                                                   //~vbzJI~//~vbzMM~
#ifdef WXE                                                         //~vbzMR~
//    PUCLIENTWE psw1,pcw2;                                                //~vbzJI~//~vbzMR~
//    int opt=0;                                                   //~vbzMR~
#endif                                                             //~vbzMR~
    char fpath[_MAX_PATH];                                         //~vbzJI~
...
//    pcw1=scrgetcw(1);                                            //~vbzMR~
//    pfh=UGETPFHFROMPCW(pcw1);                                    //~vbzMR~
//    if (pfh)                                                     //~vbzMR~
//    {                                                            //~vbzMR~
//        opt=WXEHCO_PCW1_FILE;                                    //~vbzMR~
//        if (FILEUTF8MODE(pfh))                                   //~vbzMR~
//            opt|=WXEHCO_FILE1_UTF8;                              //~vbzMR~
//    }                                                            //~vbzMR~
//    pcw2=scrgetcw(2);                                            //~vbzMR~
//    if (pcw2)                                                    //~vbzMR~
//    {                                                            //~vbzMR~
//        pfh=UGETPFHFROMPCW(pcw2);                                //~vbzMR~
//        if (pfh)                                                 //~vbzMR~
//        {                                                        //~vbzMR~
//            opt=WXEHCO_PCW2_FILE;                                //~vbzMR~
//            if (FILEUTF8MODE(pfh))                               //~vbzMR~
//                opt|=WXEHCO_FILE2_UTF8;                          //~vbzMR~
//        }                                                        //~vbzMR~
//    }                                                            //~vbzMR~
//    SoptHC=opt;                                                  //~vbzMR~
//    UTRACEP("%s:opt=0x%04x,splitv=%d,splith=%d\n",UTT,opt,splitV,splitH);//~vbzMR~
    ...
    if (rc=func_edit_file2(Ppcw,editopt),rc)                       //~vbzJI~
	    return rc;                                                 //~vbzJI~
    pcw=scrgetcw(0);                                               //~vbzJI~
    pfh=UGETPFHFROMPCW(pcw);	//#hcopy_temp                      //~vbzJI~
    getHcopy(pcw,pfh);                                             //~vbzJI~
    appendHcopy(pcw,pfh);                                          //~vbzJR~
    func_cancel_file(pcw);                                         //~vbzJR~
    return rc;                                                     //~vbzJI~
}                                                                  //~vbzJI~
