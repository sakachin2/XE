...
nmake "BINPATH=%EXEPATH32%" "VC=%VC%" "SDK=%SDK%" "ULIBHDIR=%ULIBHDIR%" "OBJULIB=%OBJULIB%" "OBJXE=%OBJXE%" "trace=yes" "os=win" "w95=vc" "w98=vc10" "source=no" "debug=yes" %1 %2 %3 /f xe.mak   
