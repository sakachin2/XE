...
//************************                                         //~v60sI~
    UTRACEP("%s:Popt=%04x,Pbinsw=%04x\n",UTT,Popt,Pbinsw);         //~vbycI~
...
//*******************                                              //~v08lI~
	UTRACEP("%s:opt=0x%04x,binsw=0x%04x\n",UTT,Popt,Pbinsw);       //~vbycR~
...
//  					UCBITOFF(Ppfh->UFHflag4,UFHF4BIN);//text file//~va6DI~//~va6JR~
                    ...
                    break;                                         //~va6DI~
                case  EOLOPT_EBCZ:     //EBC EOL(0x15) and 0d15    //~vbBuI~
                    UTRACEP("%s:opt=%c,wmode=%d,swrecordmode=%d\n",UTT,*pc,wmode,swrecordmode);//~vbBuI~
                    if (wmode||swrecordmode)                       //~vbBuI~
                    {                                              //~vbBuI~
			            uerrmsg("EOL option %c is for Text mode Read only.",//~vbBuI~
            			        "EOL オプション %c は テキストファイル Read 用です",//~vbBuR~
								EOLOPT_EBCZ);                      //~vbBuI~
            			return 4;                                  //~vbBuI~
					}                                              //~vbBuI~
                    else                                           //~vbBuI~
                    {                                              //~vbBuI~
                        wmode=1;                                   //~vbBuI~
						UCBITOFF(Ppfh->UFHflag3,UFHF3RTEXTPC|UFHF3RTEXTUNIX); //reset pc/unix write//~vbBuI~
						UCBITON(Ppfh->UFHflag11,UFHF11RTEXTEBC|UFHF11WTEXTEBC|UFHF11RTEXTEBCZ);//~vbBuI~
                        swrecordmode=-1;                           //~vbBuI~
						ERRFORBINFILE(Ppfh,"/Me");                 //~vbBuI~
						UCBITON(Ppfh->UFHflag4,UFHF4TEXT);//explicit text mode//~vbBuI~
					}                                              //~vbBuI~
                    break;                                         //~vbBuI~
...
//  uerrmsg("%c[B|C|H|I|J|K|L|N] [name|-n|--[n]] %s [L] [Ln] [[o][n[t]]-[m[t]]] [/M[m|p|u|t|e|r|v]%s[b|c|h|k][n][o|L][x][width[s]]]",0,//~vbp1R~//+vbBuR~
    uerrmsg("%c[B|C|H|I|J|K|L|N] [name|-n|--[n]] %s [L] [Ln] [[o][n[t]]-[m[t]]] [/M[m|p|u|t|e|z|r|v]%s[b|c|h|k][n][o|L][x][width[s]]]",0,//+vbBuI~
    		Pcmdid,wopt2,wopt);                                    //~vbp1I~
  else                                                             //~vbp1I~
//    uerrmsg("%c[B|C|H|I|J|K|L|N] {file|dir} %s [L] [Ln] [[o][n[t]]-[m[t]]] [/M[m|p|u|t|e|r|v]%s[b|c|h|k][n][o|L][x][width[s]]]",0,//~vaj0I~//+vbBuR~
      uerrmsg("%c[B|C|H|I|J|K|L|N] {file|dir} %s [L] [Ln] [[o][n[t]]-[m[t]]] [/M[m|p|u|t|e|z|r|v]%s[b|c|h|k][n][o|L][x][width[s]]]",0,//+vbBuI~
    		Pcmdid,wopt2,wopt);                                    //~vbp1I~
#endif                                                             //~v91QI~//~va00I~
//  		Pcmdid,wopt);                                          //~v616R~
