...
#endif                                                             //~v79zI~
    Gulibutfmode|=GULIBUTFMODE_NOTRACEMAPINIT;                     //~vbzQI~
...
//            }                                                    //~v51BR~
            ...
            {                                                      //~v51BM~
                ...
                if (pfst)                                          //~v51BM~
                {                                                  //~v51BM~
//                  if (pfst->FSTstrnew)                           //~vbzGR~
                    if (*pfst->FSTstrnew)                          //~vbzGI~
...
int func_scrHcopy(PUCLIENTWE Ppcw){return 0;}                      //~vbzJI~
char *funcsp_search(int Popt,char *Ppname){return 0;}              //~vba2I~
UCHAR *inigetfname(UCHAR *Pfname){return " ";}                     //~vbvfI~
#ifdef LNXCON                                                      //~vbzwI~
//int uvioGetCursorWidth(int Popt,ULONG Pucs){return 0;}           //~vbzwR~
#endif                                                             //~vbzwI~
