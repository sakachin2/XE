...
//* basic calc
//*************************************************************
//vbzB:240317 XBC; support translation between UCS4 and ucs2 surrogate presentation by ucalc//+vbzBI~
...
//      uerrmsg("XBC {L$|$n|[$n=]{decno|Xhexno|Ooctno} [{+|-|*|!|/|%%|<|>|&|||^} opd2] [/{X|O|D|U|Z|L}] [Vn[R]] [R]}",0);//~vb98I~//+vbzBR~
        uerrmsg("XBC {L$|$n|[$n=]{decno|Xhexno|Ooctno} [{+|-|*|!|/|%%|<|>|&|||^} opd2] [/{X|O|D|U|Z|L|S}] [Vn[R]] [R]}",0);//+vbzBI~
        return 0;                                                  //~v17iI~
    }                                                              //~v17iI~
