...
//vbBp:241107 cancel vbBd(change cp931(not exist in icu) to CP939L(cp300+cp037)). ibm doc defines cp931//~vbBpI~
...
//v7dj:241005 match convertername of cmdline /ebc:converter and cjisopt of xeebc.map//~v7djI~
...
//******************************************************           //~v57GI~
//#define EBC_US          "CP037"                                    //~vbB6R~//~vbB8R~
#define EBC_US          "CP037"                                    //~vbB8R~
#define EBC_KANA        "CP930"    //katakana intos english lowercase letter//~vbB6R~
//#define EBC_KANJI_LATIN "CP931"    //katakana intos english lowercase letter//~vbB9R~//~vbBdR~
//#define EBC_KANJI_LATIN "CP939L"    //latin(cp037)+japanese dbcs(cp300)//~vbBdR~//~vbBpR~
//#define EBC_KANJI_LATIN "CP931"    //katakana intos english lowercase letter//~vbBpI~//~vbBsR~
#define EBC_ENG         "CP939"    //english lowercase letter into katakana//~vbB6R~
#define EBC_DBCSJP      "CP300"                                    //~vbB8I~
#define EBC_SBCSKANA    "CP290"                                    //~vbB8I~
#define EBC_SBCSENG     "CP1027"                                   //~vbB8I~
...
//  #define UCVEBCS_SBCSMAPINIT   0x01 //sbcsmap was initialized   //~v660I~//~v69cR~
    ...
    #define UCVEBCS_CMDLINEOPTION 0x0100 //xe cmdline option cp930/cp939/cp037 specified//~vbB6I~
    #define UCVEBCS_CLO_CP930     0x0200 //xe cmdline option cp930 //~vbB6I~
    #define UCVEBCS_CLO_CP939     0x0400 //xe cmdline option cp939 //~vbB6I~
    #define UCVEBCS_CLO_CP037     0x0800 //xe cmdline option cp037 //~vbB6I~
    #define UCVEBCS_CLO_CP931     0x1000 //xe cmdline option LATIN //~vbB9I~
    #define UCVEBCS_CLO_CP037Euro 0x2000 //xe cmdline option cp037 //~vbBtI~
    #define UCVEBCS_CLO_ALL       (UCVEBCS_CLO_CP930| \
                                   UCVEBCS_CLO_CP939| \
                             /*    UCVEBCS_CLO_CP931|*/\
                                   UCVEBCS_CLO_CP037Euro|\
                                   UCVEBCS_CLO_CP037)              //~vbB9I~
//  #define UCVEBCS_SJISLATIN     0x2000 //cp931, dbcs+latin       //~v7djR~//~v7dmR~
    #define UCVEBCS_OLD_B2A       0x4000 //if off apply new ebc2asc login(use local converter)//~v7d9I~
//  #define UCVEBCS_SBCSLATIN     0x8000 //cp037 with NoDBCS;converter=0 and "sbcscharset=cp037 or cmdline option /ebc:Latin //~v7daI~//~v7djR~//~v7dmR~
    #define UCVEBCS_DBCSLATIN     0x8000 //modify EBC2ASC_SBCSMAP037 to accept DBCS(LATIN_EXT)//~v7dAI~
    #define UCVEBCS_UCONVERR    0x010000 //uconv cmd failed        //~v7deI~
                                                                   //~v660I~
...
#define CHAR_EBC_CP037_CURRENCY 0x9f                               //~v7dPI~
#define CHAR_UCS_EURO   0x20ac                                     //~v7dPI~
#ifdef UTF8EBCD                                                    //~v660I~
	#define CHAR_EBC_DBCS_SUBCHAR  0xfefe     //u-fffd             //~v7dQR~
...
//#define EBCID_BASE        "BASE"           //CP300 DP94 version+CP037//~v7d5R~//~v7dmR~
//#define EBCID_LATIN       "LATIN"          //CP300+cp037 = CP931   //~vbB9I~//~v7djR~
//#define EBCID_LATIN       "LATIN_EXT"      //CP300+cp037 = CP931   //~v7djI~//~vbBsR~
#endif                                                             //~v660I~
//#define EBC_STRKANA     "JPKana"                                     //~vbB8R~//~vbB9R~//~v7djR~
#define EBC_STRKANA     EBCID_KANAEXT    //KANA_EXT                //~v7djI~
//#define EBC_STRENG      "JPEng"                                      //~vbB8R~//~vbB9R~//~v7djR~
#define EBC_STRENG      EBCID_ENGEXT     //ENG_EXT                 //~v7djI~
//#define EBC_STRLATIN    "JPLatin"                                    //~vbB8R~//~vbB9R~//~v7djR~
//#define EBC_STRLATIN    EBCID_LATIN                                //~v7djI~//~vbBsR~
//#define EBC_STRUS       "US"                                       //~vbB9R~//~v7djR~
//#define EBC_STRUS       "LATIN"                                    //~v7djI~//~v7dnR~
#define EBC_STRUS       "DefaultMap"                               //~v7dnI~
#define EBC_STRUS_EURO  "DefaultMapEuro"                           //+vbBtI~
#define EBC_STREBC      "EBC"                                      //~vbB8I~
//******************************************************           //~v5edI~
...
//#define EBC2ASC_EXT_SETSUBCHRC    0x10    //set return code "subchar was set"//~v66DI~//~v7dFR~
...
//#define EBC2ASC_EXT_B2B  0x40    //NOT USED;reserved for UCVEXTO_B2B//~v69uI~//~vataR~
#define EBC2ASC_NEW      0x80    //newjis(83) seq                  //~v5edR~
//#define EBC2ASC_EXT_MBICU 0x80    //reserved for UCVEXTO_MBICU     //~v6f4R~//~vataR~
//#define EBC2ASC_CP931    0x80     //CP300 with CP037 , EBC2ASC_SBCSMAP037 is also on//~vataR~//~vbBsR~
...
//	#define EBC2ASC_OPENEDCV   0x100000 //converter is opened already//~v5mPI~//~v7dFR~
	#define EBC2ASC_EXT_SETSUBCHRC    0x100000  //set return code "subchar was set"//~v7dFI~
...
//#define EBC2ASC_BASE         0x80000000 //SJISOPT:LATIN (SBCS internal mapping=CP037)//~v7d5R~//~v7dmR~
#define EBC2ASC_SBCSMAP037     0x80000000 //SBCS is CP037, DBCS if combined EBC2ASC_CP931. DefaultMap is No DBCS//~v7dmR~//~vataR~
                                                                   //~v5eiI~
...
#define UCVEBC3O_CVCRLF             0x40000000    //by ASC2EBC_CRLF//~v7dyI~
                                                                   //~v660I~
...
#define UCVE3B2DDS1RC_SUBCHAR 0x100                                //~vbBkI~
//*******************************************************          //~v660I~
...
#define UCVE3B2DDD1RC_SUBCHAR 0x100                                //~vbBkI~
//*******************************************************          //~v660I~
...
//*******************************************************          //~vbB9I~
void ucvebcTables(UCHAR *Pebc2asc037,UCHAR *Pasc2ebc037);          //~vbB9I~
void ucvebc_adjustB2A(int Popt,void * /*PUCVEXTCFG*/ Ppcfg);        //~v7d9R~//~v7daR~
