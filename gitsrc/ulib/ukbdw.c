...
#include <ucvext.h>                                                //+v7a6I~
#include <ucvebc.h>                                                //~v5n8I~
//#include <ucvext.h>                                                //~v5n8I~//+v7a6R~
#include <utf.h>                                                   //~v6BeI~
...
#else                                                              //~v570I~
//  	        UTRACEP("%s:readctr=0 continue\n",UTT);            //~v7a6R~
            	continue;                                          //~v139R~
#endif                                                             //~v570I~
			}                                                      //~v7a6I~
		}                                                          //~v139I~
        		                                                   //~v139I~
//      UTRACEP("%s:eventtype=%x focuseventctr=%d\n",UTT,inprec.EventType,focuseventctr);//~v7a6R~
...
//          	UTRACEP("%s:focusevent ctr=%d,bSetFocus=%d\n",UTT,focuseventctr,inprec.Event.FocusEvent.bSetFocus);//~v7a6R~
...
//  		UTRACEP("%s:not keyevent continue\n",UTT);             //~v7a6R~
...
//  		    UTRACEP("%s:keydown break shift=0x%04x\n",UTT,newshift);//~v7a6R~
                break;                                                 //~v139R~
            }                                                          //~v139I~
//          UTRACEP("%s:keydown\n",UTT);                           //~v7a6R~
        }                                                          //~v146I~
...
//      UTRACEP("%s:Sshiftreprtsw=%d\n",UTT,Sshiftreprtsw);        //~v7a6R~
		if (Sshiftreprtsw)                                         //~v146I~
#ifdef WXE                                                         //~v5biM~
...
UTRACEP("%s:event scan=x%02x,char=x%02x\n",UTT,Ppkinfo->chScan,Ppkinfo->chChar);//~v701I~//~v724R~
                                                                   //~v139R~
...
//          oldmode=0xffffffff;                                    //~v204I~//~v7a6R~
        }                                                          //~v204I~
        else                                                       //~v204I~
	  if (Pid)                                                     //~v141I~
