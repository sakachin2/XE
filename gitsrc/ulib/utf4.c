...
//v7b9:240325 WIN:move private(e000-f8ff:Ambiguous) to "not selected Ambigouous-lang". (v79k was not effective, the tbl for japanese is not used now)//~v7b9I~
//            Win textDraw is heavy but not so heavy on linux. Win use ExtentPoint for not ambiguous width=1//~v7b9I~
//v7b6:240323 set 00ad(soft hiphen) and not format(so width=1)     //~v7b6I~
//vbzz:240311 arrange vbz3,vbzp:/Yv and vbzy:YL to /Gv[L]          //~v7zyI~
//vbzy:240310 /YL, optionally ambiguous chk for language by performance reason.//~v7zyI~
//v7am:240310 update ambiguous_langs(except latin and greece)      //~v7amI~
...
#include <uvio.h>                                                  //~v7zyR~
#include <uvio2.h>                                                 //~v7zyI~
                                                                   //~7719I~
...
//        if (utf4_isAmbiguous_NoCJK(0,(UWUCS)ucs))                  //~v79oI~//~vbzzR~
//            return 2+UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v6WnI~//~vbzzR~
        if (rc2=utf4_isAmbiguous_NoCJK(0,(UWUCS)ucs),rc2)          //~vbzzI~
            return rc2;                                            //~vbzzI~
//#else                                                              //~v6WnI~//~v79wR~
...
//        if (utf4_isAmbiguous_NoCJK(0,(UWUCS)ucs))                  //~v79fI~//~vbzzR~
//            return 2+UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v79fI~//~vbzzR~
        if (rc2=utf4_isAmbiguous_NoCJK(0,(UWUCS)ucs),rc2)          //~vbzzI~
            return rc2;                                            //~vbzzI~
//#endif                                                             //~v79fI~//~v79iR~
//#else                                                              //~v79oI~//~v79wR~
...
//*unicode database  all of type'A'                                //~v79KI~
...
//{0x00ad,0x00ae}, //[2 lines]  Cf         SOFT HYPHEN               //~v79vI~//~v7b6R~
{0x00ae,0x00ae}, //[2 lines]  Cf         SOFT HYPHEN               //~v7b6I~
...
#ifdef W32                                                         //~v6WpR~
//*same as Sambiguous_non_langs**                                  //~v79KI~
...
#endif                                                             //~v6WpI~
//*lang is optionally glyphchk, exception is glyph chk regardless. //~v7amI~
  static const struct interval Sambiguous_langs_selected[] = {     //~v7amI~
     { 0x0370, 0x03ff } //  greece,copt                            //~v7amI~
    ,{ 0x0400, 0x04ff } //  cyrillic                               //~v7amR~
    ,{ 0x0500, 0x052f } //  cyrilic Supplement                     //~v7amR~
    ,{ 0x1e00, 0x1eff } //  Latic extended additional              //~v7amI~
    ,{ 0x1f00, 0x1fff } //  Greek Extended, conform glyph width    //~v7amI~
    ,{ 0x2000, 0x2bff } //  common, partially duplicated with non_lang//~v7amI~
    ,{ 0x2de0, 0x2dff } //  Cyrillic Extended-A                    //~v7amI~
    ,{ 0x2e00, 0x2e7f } //  common punctuation                     //~v7amI~
    ,{ 0xa640, 0xa69f } //  Cyrillic Extended-B                    //~v7amI~
    ,{ 0xa720, 0xa7ff } //  Latin Extended-D                       //~v7amI~
  };                                                               //~v7amI~
//*specify all char in the specific language block**                        //~v6V2I~//~v6V8R~
  static const struct interval Sambiguous_langs[] = {              //~v6V2I~
     { 0x0370, 0x03ff } //  greece,copt                            //~v7amI~
    ,{ 0x0400, 0x04ff } //  cyrillic                               //~v7amR~
    ,{ 0x0500, 0x052f } //  cyrilic Supplement                     //~v6V2I~//~v6VbR~//~v7amR~
...
//  ,{ 0x16a0, 0x16ff } //  Runic ,looks like sbcs                 //~v6V2I~
    ,{ 0x16a0, 0x16ff } //  Runic confirm glyph width optionally   //~v7amI~
    ,{ 0x1700, 0x171f } //  Tagalog                                //~v6V2I~
//  ,{ 0x1720, 0x173f } //  Hanunoo,looks like sbcs                //~v6V2I~
    ,{ 0x1720, 0x173f } //  Hanunoo,confirm glyph width optionally //~v7amI~
...
//  ,{ 0x1f00, 0x1fff } //  Greek Extended (sbcs)                  //~v6V2I~
    ,{ 0x1f00, 0x1fff } //  Greek Extended, conform glyph width    //~v7amI~
    ,{ 0x2000, 0x2bff } //  common, partially duplicated with non_lang//~v7amR~
    ...
    ,{ 0x2e00, 0x2e7f } //  common punctuation                     //~v7amR~
//  ,{ 0x2e80, 0xa4cf } //  cjk                                    //~v7amR~
//  ,{ 0x303f, 0x303f } //  not DBCS by mk_wcwidth                 //~v799I~//~v7ccR~
    ,{ 0xa000, 0xa48f } //  Yi Syllables                           //~v7cbI~
    ,{ 0xa490, 0xa4cf } //  Yi Radicals                            //~v7cbI~
    ...
    ,{ 0xa700, 0xa71f } //  Modifier Tone Letters, common          //~v7amR~
...
//  ,{ 0xd7b0, 0xd7ff } //  Hangul Jambo Exteded-B(dbcs)           //~v6V2I~//~v7amR~
...
////U+10000..U+1007F  :Linear B Syllabary:Linear B                   //~v6V2I~//~v7baR~
//    ,{0x10000, 0x1007f }                                         //~v7baR~
////U+10080..U+100FF  :Linear B Ideograms:Linear B                   //~v6V2I~//~v7baR~
//    ,{0x10080, 0x100ff }                                         //~v7baR~
////U+10100..U+1013F  :Aegean Numbers:Common                         //~v6V2I~//~v7baR~
//    ,{0X10100,0X1013F}                                                 //~v6V2I~//~v6V8R~//~v7baR~
////U+10140..U+1018F  :Ancient Greek Numbers:Greek                   //~v6V2I~//~v7baR~
//    ,{0X10140,0X1018f}                                                 //~v6V2R~//~v6V8R~//~v7baR~
////U+10190..U+101CF  :Ancient Symbols:Greek (1 character), Common (12 characters)//~v6V2I~//~v7baR~
//    ,{0x10190,0x101CF}                                                 //~v6V2R~//~v6V8R~//~v7baR~
////U+101D0..U+101FF  :Phaistos Disc:Common (45 characters), Inherited (1 character)//~v6V2I~//~v7baR~
//    ,{0X101d0,0X101ff}                                                 //~v6V2I~//~v6V8R~//~v7baR~
    ,{0X10000,0X101ff}                                             //~v7baI~
////U+10280..U+1029F  :Lycian:Lycian                                 //~v6V2I~//~v7baR~
//    ,{0X10280,0X1029f}                                           //~v7baR~
////U+102A0..U+102DF  :Carian:Carian                                 //~v6V2I~//~v7baR~
//    ,{0X102a0,0X102df}                                           //~v7baR~
////U+102E0..U+102FF  :Coptic Epact Numbers:Common (27 characters), Inherited (1 character)//~v6V2I~//~v7baR~
//    ,{0x102E0, 0x102FF}  //102e0:wcwidth=0                             //~v6V2I~//~v6V8R~//~v7baR~
////U+10300..U+1032F  :Old Italic:Old Italic                         //~v6V2I~//~v7baR~
//    ,{0x10300, 0x1032F}                                                //~v6V2I~//~v6V8R~//~v7baR~
//////1 SMP                                                          //~v6V2I~//~v7baR~
////U+10330..U+1034F  :Gothic:Gothic                                 //~v6V2I~//~v7baR~
//    ,{0x10330, 0x1034F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+10350..U+1037F  :Old Permic:Old Permic                         //~v6V2I~//~v7baR~
//    ,{0x10350, 0x1037F}                                          //~v7baR~
////U+10380..U+1039F  :Ugaritic:Ugaritic                             //~v6V2I~//~v7baR~
//    ,{0x10380, 0x1039F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+103A0..U+103DF  :Old Persian:Old Persian                       //~v6V2I~//~v7baR~
//    ,{0x103A0, 0x103DF}                                                //~v6V2I~//~v6V8R~//~v7baR~
    ,{0x10280, 0x103DF}                                            //~v7baI~
////U+10400..U+1044F  :Deseret:Deseret                               //~v6V2I~//~v7baR~
//    ,{0x10400, 0x1044F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+10450..U+1047F  :Shavian:Shavian                               //~v6V2I~//~v7baR~
//    ,{0x10450, 0x1047f}                                          //~v7baR~
////U+10480..U+104AF  :Osmanya:Osmanya                               //~v6V2I~//~v7baR~
//    ,{0x10480, 0x104AF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+104B0..U+104FF  :Osage:Osage                                   //~v6V2I~//~v7baR~
//    ,{0x104b0, 0x104ff}                                          //~v7baR~
////U+10500..U+1052F  :Elbasan:Elbasan                               //~v6V2I~//~v7baR~
//    ,{0x10500, 0x1052f}                                          //~v7baR~
////U+10530..U+1056F  :Caucasian Albanian:Caucasian Albanian         //~v6V2I~//~v7baR~
//    ,{0x10530, 0x1056f}                                          //~v7baR~
    ,{0x10400, 0x1056f}                                            //~v7baI~
////1 SMP                                                          //~v6V2I~
//U+10600..U+1077F  :Linear A:Linear A                             //~v6V2I~
    ,{0x10600, 0x1077f}                                            //~v7baI~
////U+10800..U+1083F  :Cypriot Syllabary:Cypriot                     //~v6V2I~//~v7baR~
//    ,{0x10800, 0x1083f}                                          //~v7baR~
////U+10840..U+1085F  :Imperial Aramaic:Imperial Aramaic             //~v6V2I~//~v7baR~
//    ,{0x10840, 0x1085f}                                          //~v7baR~
////U+10860..U+1087F  :Palmyrene:Palmyrene                           //~v6V2I~//~v7baR~
//    ,{0x10860, 0x1087f}                                          //~v7baR~
////U+10880..U+108AF  :Nabataean:Nabataean                           //~v6V2I~//~v7baR~
//    ,{0x10880, 0x108af}                                          //~v7baR~
    ,{0x10800, 0x108af}                                            //~v7baI~
////U+108E0..U+108FF  :Hatran:Hatran                                 //~v6V2I~//~v7baR~
//    ,{0x108e0, 0x108ff}                                          //~v7baR~
////U+10900..U+1091F  :Phoenician:Phoenician                         //~v6V2I~//~v7baR~
//    ,{0x10900, 0x1091F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+10920..U+1093F  :Lydian:Lydian                                 //~v6V2I~//~v7baR~
//    ,{0x10920, 0x1093F}                                          //~v7baR~
    ,{0x108e0, 0x1093F}                                            //~v7baI~
////U+10980..U+1099F  :Meroitic Hieroglyphs:Meroitic Hieroglyphs     //~v6V2I~//~v7baR~
//    ,{0x10980, 0x1099F}                                          //~v7baR~
////U+109A0..U+109FF  :Meroitic Cursive:Meroitic Cursive             //~v6V2I~//~v7baR~
//    ,{0x109a0, 0x109ff}                                          //~v7baR~
//////1 SMP                                                          //~v6V2I~//~v7baR~
////U+10A00..U+10A5F  :Kharoshthi:Kharoshthi                         //~v6V2I~//~v7baR~
//    ,{0x10a00, 0x10a5f}                                          //~v7baR~
////U+10A60..U+10A7F  :Old South Arabian:Old South Arabian           //~v6V2I~//~v7baR~
//    ,{0x10a60, 0x10a7f}                                          //~v7baR~
////U+10A80..U+10A9F  :Old North Arabian:Old North Arabian           //~v6V2I~//~v7baR~
//    ,{0x10a80, 0x10a9f}                                          //~v7baR~
    ,{0x10980, 0x10a9f}                                            //~v7baI~
////U+10AC0..U+10AFF  :Manichaean:Manichaean                         //~v6V2I~//~v7baR~
//    ,{0x10ac0, 0x10aff}                                          //~v7baR~
////U+10B00..U+10B3F  :Avestan:Avestan                               //~v6V2I~//~v7baR~
//    ,{0x10b00, 0x10b3f}                                          //~v7baR~
////U+10B40..U+10B5F  :Inscriptional Parthian:Inscriptional Parthian //~v6V2I~//~v7baR~
//    ,{0x10b40, 0x10b5f}                                          //~v7baR~
////U+10B60..U+10B7F  :Inscriptional Pahlavi:Inscriptional Pahlavi   //~v6V2I~//~v7baR~
//    ,{0x10b60, 0x10b7f}                                          //~v7baR~
////U+10B80..U+10BAF  :Psalter Pahlavi:Psalter Pahlavi               //~v6V2I~//~v7baR~
//    ,{0x10b80, 0x10baf}                                          //~v7baR~
    ,{0x10ac0, 0x10baf}                                            //~v7baI~
//U+10C00..U+10C4F  :Old Turkic:Old Turkic                         //~v6V2I~
    ,{0x10c00, 0x10c4f}                                            //~v7baI~
//U+10C80..U+10CFF  :Old Hungarian:Old Hungarian                   //~v6V2I~
    ,{0x10c80, 0x10cff}                                            //~v7baI~
////1 SMP                                                          //~v6V2I~
//2024/07/04 web unicode block ***                                 //~v7cbI~
//U+10D00..U+10D3F    Hanifi Rohingya                              //~v7cbI~
//U+10E80..U+10EBF    Yezidi                                       //~v7cbI~
//U+10EC0..U+10EFF    Arabic Extended-C                            //~v7cbI~
//U+10F00..U+10F2F    Old Sogdian                                  //~v7cbI~
//U+10F30..U+10F6F    Sogdian                                      //~v7cbI~
//U+10F70..U+10FAF    Old Uyghur                                   //~v7cbI~
//U+10FB0..U+10FDF    Chorasmian                                   //~v7cbI~
//U+11800..U+1184F    Dogra                                        //~v7cbI~
//U+11900..U+1195F    Dives Akuru                                  //~v7cbI~
//U+119A0..U+119FF    Nandinagari                                  //~v7cbI~
//U+11A50..U+11AAF    Soyombo                                      //~v7cbI~
//U+11AB0..U+11ABF    Unified Canadian Aboriginal Syllabics Extended-A//~v7cbI~
//U+11EE0..U+11EFF    Makasar                                      //~v7cbI~
//U+11F00..U+11F5F    Kawi                                         //~v7cbI~
//U+11FB0..U+11FBF    Lisu Supplement                              //~v7cbI~
//U+11FC0..U+11FFF    Tamil Supplement                             //~v7cbI~
//U+12F90..U+12FFF    Cypro-Minoan                                 //~v7cbI~
//U+16E40..U+16E9F    Medefaidrin                                  //~v7cbI~
//U+18B00..U+18CFF    Khitan Small Script                          //~v7cbI~
//U+18D00..U+18D7F    Tangut Supplement                            //~v7cbI~
                                                                   //~v7cbI~
//U+1D2C0..U+1D2DF    Kaktovik Numerals                            //~v7cbI~
//U+1D2E0..U+1D2FF    Mayan Numerals                               //~v7cbI~
//U+1E030..U+1E08F    Cyrillic Extended-D                          //~v7cbI~
//U+1E100..U+1E14F    Nyiakeng Puachue Hmong                       //~v7cbI~
//U+1E290..U+1E2BF    Toto                                         //~v7cbI~
//U+1E2C0..U+1E2FF    Wancho                                       //~v7cbI~
//U+1E4D0..U+1E4FF    Nag Mundari                                  //~v7cbI~
...
//    ,{0x11080, 0x110cf}                                          //~v7baR~
////U+110D0..U+110FF  :Sora Sompeng:Sora Sompeng                     //~v6V2I~//~v7baR~
//    ,{0x110d0, 0x110ff}                                          //~v7baR~
////U+11100..U+1114F  :Chakma:Chakma                                 //~v6V2I~//~v7baR~
//    ,{0x11100, 0x1114f}                                          //~v7baR~
////U+11150..U+1117F  :Mahajani:Mahajani                             //~v6V2I~//~v7baR~
//    ,{0x11150, 0x1117f}                                          //~v7baR~
////U+11180..U+111DF  :Sharada:Sharada                               //~v6V2I~//~v7baR~
//    ,{0x11180, 0x111df}                                          //~v7baR~
////U+111E0..U+111FF  :Sinhala Archaic Numbers:Sinhala               //~v6V2I~//~v7baR~
//    ,{0x111e0, 0x111ff}                                          //~v7baR~
////U+11200..U+1124F  :Khojki:Khojki                                 //~v6V2I~//~v7baR~
//    ,{0x11200, 0x1124f}                                          //~v7baR~
    ,{0x11000, 0x1124f}                                            //~v7baI~
////U+11280..U+112AF  :Multani:Multani                               //~v6V2I~//~v7baR~
//    ,{0x11280, 0x112af}                                          //~v7baR~
//////1 SMP                                                          //~v6V2I~//~v7baR~
////U+112B0..U+112FF  :Khudawadi:Khudawadi                           //~v6V2I~//~v7baR~
//    ,{0x112b0, 0x112ff}                                          //~v7baR~
////U+11300..U+1137F  :Grantha:Grantha                               //~v6V2I~//~v7baR~
//    ,{0x11300, 0x1137f}                                          //~v7baR~
    ,{0x11280, 0x1137f}                                            //~v7baI~
////U+11400..U+1147F  :Newa:Newa                                     //~v6V2I~//~v7baR~
//    ,{0x11400, 0x1147f}                                          //~v7baR~
////U+11480..U+114DF  :Tirhuta:Tirhuta                               //~v6V2I~//~v7baR~
//    ,{0x11480, 0x114df}                                          //~v7baR~
    ,{0x11400, 0x114df}                                            //~v7baI~
////U+11580..U+115FF  :Siddham:Siddham                               //~v6V2I~//~v7baR~
//    ,{0x11580, 0x115ff}                                          //~v7baR~
////U+11600..U+1165F  :Modi:Modi                                     //~v6V2I~//~v7baR~
//    ,{0x11600, 0x1165f}                                          //~v7baR~
////U+11660..U+1167F  :Mongolian Supplement:Mongolian                //~v6V2I~//~v7baR~
//    ,{0x11660, 0x1167f}                                          //~v7baR~
////U+11680..U+116CF  :Takri:Takri                                   //~v6V2I~//~v7baR~
//    ,{0x11680, 0x116cf}                                          //~v7baR~
    ,{0x11580, 0x116cf}                                            //~v7baI~
...
//    ,{0x11c00, 0x11c6f}                                          //~v7baR~
////U+11C70..U+11CBF  :Marchen:Marchen                               //~v6V2I~//~v7baR~
//    ,{0x11c70, 0x11cbf}                                          //~v7baR~
...
//U+14400..U+1467F  :Anatolian Hieroglyphs:Anatolian Hieroglyphs   //~v6V2I~
    ,{0x14400, 0x1467f}                                            //~v7baI~
////U+16800..U+16A3F  :Bamum Supplement:Bamum                        //~v6V2I~//~v7baR~
//    ,{0x16800, 0x16a3f}                                          //~v7baR~
////U+16A40..U+16A6F  :Mro:Mro                                       //~v6V2I~//~v7baR~
//    ,{0x16a40, 0x16a6f}                                          //~v7baR~
    ,{0x16800, 0x16a6f}                                            //~v7baI~
////U+16AD0..U+16AFF  :Bassa Vah:Bassa Vah                           //~v6V2I~//~v7baR~
//    ,{0x16ad0, 0x16aff}                                          //~v7baR~
...
//    ,{0x16fe0, 0x16fff}                                          //~v7baR~
////U+17000..U+187FF  :Tangut:Tangut                                 //~v6V2I~//~v7baR~
//    ,{0x17000, 0x187ff}                                          //~v7baR~
...
//////1 SMP                                                          //~v6V2I~//~v7baR~
////U+1B100..U+1B12F  :Kana Extended-A:Hiragana                      //~v6V2I~//~v7baR~
//    ,{0x1b100, 0x1b12f}                                          //~v7baR~
    ,{0x1b000, 0x1b12f}                                            //~v7baI~
//U+1B170..U+1B2FF  :Nushu:Nﾃｼshu                                   //~v6V2I~
    ,{0x1b170, 0x1b2ff}                                            //~v7baI~
////U+1BC00..U+1BC9F  :Duployan:Duployan                             //~v6V2I~//~v7baR~
//    ,{0x1bc00, 0x1bc9f}                                          //~v7baR~
////U+1BCA0..U+1BCAF  :Shorthand Format Controls:Common              //~v6V2I~//~v7baR~
//    ,{0x1bca0, 0x1bcaf}                                          //~v7baR~
    ,{0x1bc00, 0x1bcaf}                                            //~v7baI~
////U+1D000..U+1D0FF  :Byzantine Musical Symbols:Common              //~v6V2I~//~v7baR~
//    ,{0x1D000, 0x1D0FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1D100..U+1D1FF  :Musical Symbols:Common (209 characters), Inherited (22 characters)//~v6V2I~//~v7baR~
//    ,{0x1D100, 0x1D1FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
...
//    ,{0x1D360, 0x1D37F}                                                //~v6V2I~//~v6V8R~//~v7baR~
    ,{0x1D300, 0x1D37F}                                            //~v7baR~
////U+1D400..U+1D7FF  :Mathematical Alphanumeric Symbols:Common      //~v6V2I~//~v7baR~
//    ,{0x1D400, 0x1D7FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
//////1 SMP                                                          //~v6V2I~//~v7baR~
////U+1D800..U+1DAAF  :Sutton SignWriting:SignWriting                //~v6V2I~//~v7baR~
//    ,{0x1d800, 0x1daaf}                                          //~v7baR~
...
//    ,{0x1F000, 0x1F02F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F030..U+1F09F  :Domino Tiles:Common                           //~v6V2I~//~v7baR~
//    ,{0x1F030, 0x1F09F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F0A0..U+1F0FF  :Playing Cards:Common                          //~v6V2I~//~v7baR~
//    ,{0x1F0A0, 0x1F0FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F100..U+1F1FF  :Enclosed Alphanumeric Supplement:Common       //~v6V2I~//~v7baR~
//    ,{0x1F100,0x1F1FF}                                                 //~v6V2I~//~v6V8R~//~v7baR~
////U+1F200..U+1F2FF  :Enclosed Ideographic Supplement:Hiragana (1 character), Common (63 characters)//~v6V2I~//~v7baR~
////,{0x1F200,0x1F2FF} //wcwidth=2                                   //~v6V2I~//~v7baR~
//    ,{0x1F200,0x1F2FF} //wcwidth=2                               //~v7baR~
//////1 SMP                                                          //~v6V2I~//~v7baR~
////U+1F300..U+1F5FF  :Miscellaneous Symbols and Pictographs:Common  //~v6V2I~//~v7baR~
//    ,{0x1F300, 0x1F5FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F600..U+1F64F  :Emoticons:Common                              //~v6V2I~//~v7baR~
////,{0x1F600,0x1F64f} //wcwidth=2                                   //~v6V8I~//~v7baR~
//    ,{0x1F600,0x1F64f} //wcwidth=2                               //~v7baR~
////U+1F650..U+1F67F  :Ornamental Dingbats:Common                    //~v6V2I~//~v7baR~
//    ,{0x1F650, 0x1F67F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F680..U+1F6FF  :Transport and Map Symbols:Common              //~v6V2I~//~v7baR~
//    ,{0x1F680, 0x1F6FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F700..U+1F77F  :Alchemical Symbols:Common                     //~v6V2I~//~v7baR~
//    ,{0x1F700, 0x1F77F}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F780..U+1F7FF  :Geometric Shapes Extended:Common              //~v6V2I~//~v7baR~
//    ,{0x1F780, 0x1F7FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F800..U+1F8FF  :Supplemental Arrows-C:Common                  //~v6V2I~//~v7baR~
//    ,{0x1F800, 0x1F8FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
////U+1F900..U+1F9FF  :Supplemental Symbols and Pictographs:Common   //~v6V2I~//~v7baR~
//    ,{0x1F900, 0x1F9FF}                                                //~v6V2I~//~v6V8R~//~v7baR~
    ,{0x1F000, 0x1F9FF}                                            //~v7baI~
//2 SIP                                                            //~v6V2I~
...
//******************************************************************//~v7zyI~
//*chk abiguous by language                                        //~v7zyI~
//*rc=UTFWWF_RC_AMBIGAMBIG/UTFWWF_RC_AMBIGLANG                     //~vbzzR~
//******************************************************************//~v7zyI~
int chkAmbiguousLanguage(UWUCS ucs)                                //~v7zyR~
{                                                                  //~v7zyI~
	int rc=0;                                                      //~v7zyI~
	if (bisearch(ucs, Sambiguous_langs_selected,                   //~v7zyI~
    ...
    {                                                              //~vbzzI~
        int rc2=0;                                                 //~vbzzI~
        if (bisearch(ucs, Sambiguous_langs,                            //~v7zyI~//~vbzzR~
               sizeof(Sambiguous_langs) / sizeof(struct interval) - 1))//~v7zyI~//~vbzzR~
        {                                                          //~vbzzI~
            rc2=1;                                                 //~vbzzI~
          	UTRACEP("%s:0x%04x ambiguous langs\n",UTT,ucs);        //~vbzzI~
        }                                                          //~vbzzI~
        else                                                       //~vbzzI~
        if (bisearch(ucs, Sambiguous_langs_ucs4,                   //~vbzzI~
                 sizeof(Sambiguous_langs_ucs4) / sizeof(struct interval) - 1))//~vbzzI~
        {                                                          //~vbzzI~
          	rc2=1;                                                 //~vbzzR~
          	UTRACEP("%s:0x%04x ambiguous langs_ucs4\n",UTT,ucs);   //~vbzzR~
        }                                                          //~vbzzI~
        if (rc2)                                                   //~vbzzI~
        {                                                              //~v7zyI~//~vbzzR~
...
//                rc=2;         //return ambiguous, glyphchk       //~vbzzR~
//            else                                                 //~vbzzR~
//            if (Gulibutfmode & GULIBUTFMODE_AMBIGLANG) //  0x4000 //chk glyph width fo ambiguous_langs//~v7zyI~//~vbzzR~
//                rc=2;         //return ambiguous, glyphchk                                   //~v7zyI~//~vbzzR~
//            else                                                 //~vbzzR~
//            if (Guvio2Stat & UVIO2S_AMBIG_UNP)  //ambiguous by lang is tobe 1 cell//~vbzzR~
//            {                                                    //~vbzzR~
//                UTRACEP("%s:0x%04x ambiguous_langs_NOT_selected,set unprintable by /GY0\n",UTT,ucs);//~vbzzR~
//                rc=2+UTFWWF_RC_AMBIG_UNP;                        //~vbzzR~
//            }                                                    //~vbzzR~
//            else                                                 //~vbzzR~
//            if (Guvio2Stat & UVIO2S_AMBIG_SBCS) //ambiguous by lang is tobe 1 cell//~vbzzR~
//            {                                                    //~vbzzR~
//                UTRACEP("%s:0x%04x ambiguous_langs_NOT_selected,set SBCS by /GY1\n",UTT,ucs);//~vbzzR~
//                rc=-2;  //-2+3=1 not ambiguous but sbcs          //~vbzzR~
//            }                                                    //~vbzzR~
//            else                                                 //~vbzzR~
//            {                                                    //~vbzzR~
//                UTRACEP("%s:0x%04x ambiguous_langs_NOT_selected,set DBCS by /GY2\n",UTT,ucs);//~vbzzR~
//                rc=-1; //-1+3=2 not ambiguous but dbcs           //~vbzzR~
//            }                                                    //~vbzzR~
    }                                                              //~vbzzI~
    UTRACEP("%s:rc=0x%04x,0x%04x,Gulibutfmode=0x%04x,Guvio2Stat=0x%04x\n",UTT,rc,ucs,Gulibutfmode,Guvio2Stat);//~vbzzR~
  	return rc;                                                     //~v7zyI~
}                                                                  //~v7zyI~
//******************************************************************//~v6VbI~
...
//      return 1|UTFWWF_RC_MK_WCWIDTH|UTFWWF_RC_FORMAT; //0x01000000+0x04000000//~v6WiI~//~v6WjI~//~v6WnR~
    if (!mk_wcwidth_combining(ucs)) //rc=0:combining               //~v6WnI~
		return UTFWWF_RC_MK_WCWIDTH|UTFWWF_COMB; //by mk_wcwidth() adjustable by wcwidth() but not for combining//~v6WnI~
  if (utf4_isAmbiguousAmbiguous(ucs)) //chk at first for the case duplicated to lang//~vbzzR~
  {                                                                //~vbzzI~
    rc=2;                                                          //~vbzzI~
...
////if (bisearch(ucs, Sambiguous_langs,                            //~v7zyR~
//  if ((Gulibutfmode & GULIBUTFMODE_AMBIGLANG) //  0x4000 //chk glyph width fo ambiguous_langs//~v7zyR~
//  &&  bisearch(ucs, Sambiguous_langs,                            //~v7zyR~
//           sizeof(Sambiguous_langs) / sizeof(struct interval) - 1))//~v6V2I~//~v7zyR~
//  {                                                                //~v6WnI~//~v7zyR~
////  return 2;                                                      //~v6V2I~//~v6V8R~//~v7zyR~
////  return 2+UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v6V8I~//~v6W9R~//~v7zyR~
//    rc=2;                                                          //~v6W9I~//~v7zyR~
//    UTRACEP("%s:0x%04x ambiguous_langs\n",UTT,ucs);                   //~v70iR~//~v7zyR~
//  }                                                                //~v6WnI~//~v7zyR~
//  else                                                           //~v7zyR~
//  if (!(Gulibutfmode & GULIBUTFMODE_AMBIGLANG) //  0x4000 //chk glyph width fo ambiguous_langs//~v7zyR~
//  &&  bisearch(ucs, Sambiguous_langs_selected,                   //~v7zyR~
//           sizeof(Sambiguous_langs_selected) / sizeof(struct interval) - 1))//~v7zyR~
//  {                                                              //~v7zyR~
//    rc=2;                                                        //~v7zyR~
//    UTRACEP("%s:0x%04x ambiguous_langs_selected\n",UTT,ucs);     //~v7zyR~
//  }                                                              //~v7zyR~
//  else                                                             //~v6WkI~//~vbzzR~
//  if (bisearch(ucs, Sambiguous_langs_ucs4,                         //~v6V2I~//~vbzzR~
//           sizeof(Sambiguous_langs_ucs4) / sizeof(struct interval) - 1))//~v6V2I~//~vbzzR~
//  {                                                                //~v6WnI~//~vbzzR~
////  return 2;                                                      //~v6V2I~//~v6V8R~//~vbzzR~
////  return 2+UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v6V8I~//~v6W9R~//~vbzzR~
//    rc=2;                                                          //~v6W9I~//~vbzzR~
//    UTRACEP("%s:0x%04x ambiguous lang_ucs4\n",UTT,ucs);              //~v6WnI~//~v79zR~//~vbzzR~
//  }                                                                //~v6WnI~//~vbzzR~
//  else                                                             //~v6WkI~//~vbzzR~
#endif                                                             //~v6V2I~
  /* binary search in table of non-spacing characters */           //~7719I~
...
//  if (utf4_isAmbiguousAmbiguous(ucs))                              //~v79vR~//~vbzzR~
//  {                                                                //~v6WnI~//~vbzzR~
////  return 2;                                                      //~7719I~//~v6V8R~//~vbzzR~
////  return 2+UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v6V8I~//~v6W9R~//~vbzzR~
//    rc=2;                                                          //~v6W9I~//~vbzzR~
////  UTRACEP("%s:0x%04x ambiguous\n",UTT,ucs);                        //~v70iR~//~v79zR~//~vbzzR~
//  }                                                                //~v6WnI~//~vbzzR~
  if (rc2=chkAmbiguousLanguage(ucs),rc2)	                       //~v7zyR~//~vbzzM~
  {                                                                //~vbzzM~
  	rc=rc2;                                                        //~v7zyR~//~vbzzM~
  }                                                                //~vbzzM~
    break;                                                         //~v6W9I~
...
//            UTRACEP("%s:0x%04x ambiguous to fixed rc=%d\n",UTT,ucs,rc);//~vbzzR~
//        }                                                        //~vbzzR~
    	return rc|=UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v6W9I~//~vbzzR~
    }                                                              //~v6W9I~
#endif                                                             //~v6W9I~
...
//rc:1:SCM, 2:combining(width=0) but trateas SCM by option.(3099/309a)          //~v6X0I~//~v7baR~
...
//  	return UTFWWF_RC_MK_WCWIDTH|UTFWWF_COMB; //by mk_wcwidth() adjustable by wcwidth() but not for combining//~v79fI~
   	if (utf4_isAmbiguousAmbiguous(Pucs))                           //~vbzzI~
  	{                                                              //~vbzzI~
    	rc=2;                                                      //~vbzzI~
  	}                                                              //~vbzzI~
    else                                                           //~vbzzI~
...
//    if (bisearch(Pucs, Sambiguous_langs,                           //~v79fR~//~vbzzR~
//           sizeof(Sambiguous_langs) / sizeof(struct interval) - 1))//~v79fI~//~vbzzR~
//    {                                                              //~v79fI~//~vbzzR~
//        rc=2;                                                      //~v79fI~//~vbzzR~
//    }                                                              //~v79fI~//~vbzzR~
    if (rc2=chkAmbiguousLanguage(Pucs),rc2)                        //~vbzzR~
    {                                                              //~vbzzR~
  	    rc=rc2;                                                    //~vbzzR~
    }                                                              //~vbzzR~
//    else                                                           //~v79fI~//~vbzzR~
//    if (bisearch(Pucs, Sambiguous_langs_ucs4,                      //~v79fR~//~vbzzR~
//           sizeof(Sambiguous_langs_ucs4) / sizeof(struct interval) - 1))//~v79fI~//~vbzzR~
//    {                                                              //~v79fI~//~vbzzR~
//        rc=2;                                                      //~v79fI~//~vbzzR~
//    }                                                              //~v79fI~//~vbzzR~
//    else                                                           //~v79fI~//~vbzzR~
...
//    if (utf4_isAmbiguousAmbiguous(Pucs))                           //~v79vI~//~vbzzR~
//    {                                                              //~v79fI~//~vbzzR~
//        rc=2;                                                      //~v79fI~//~vbzzR~
//    }                                                              //~v79fI~//~vbzzR~
...
//        if (rc<0)                                                //~vbzzR~
//        {                                                        //~vbzzR~
//            rc+=3;//-2+3=1:sbcs, -1+3=2:dbcs by /GYx option      //~vbzzR~
//            UTRACEP("%s:0x%04x ambiguous to fixed rc=%d\n",UTT,Pucs,rc);//~vbzzR~
//        }                                                        //~vbzzR~
    	rc|=UTFWWO_MK_AMBIGUOUS; //x2000   //by mk_wcwidth() adjustable by wcwidth()//~v79fI~
    	UTRACEP("%s:rc=0x%04x,ucs=0x%04x\n",UTT,rc,Pucs);              //~v79fI~//~v79iR~//~v79KR~
    }                                                              //~v79fI~
#endif                                                             //~v79fI~
                                                                   //~v79fI~
//  Sfromcjk=1;                                                    //~v79fI~
...
//*rc:1:combining2(dakuten/handakuten), 0:not combining                                //~v6X0R~//~v7baR~
//***************************************************************  //~v6X0I~
