//CID://+v7dBR~:      update#=      7                              //~v6B2R~//+v7dBR~
//*********************************************************************
//* common routine hdr                                             //~v021R~
//*********************************************************************
//v7dB:241028 linux compiler waring add UiUIBITON  to on UINT to int//+v7dBI~
...
#define UIUIBITON(uc,bit)		\
		uc=(int)((UINT)(uc) | (bit))                               //+v7dBI~
#define UIBITOFF(uc,bit)		\
		uc=(UINT)((uc) & ~(bit))                                   //~v6k4I~
#define UIUIBITOFF(uc,bit)		\
		uc=(int)((UINT)(uc) & ~(bit))                              //+v7dBI~
