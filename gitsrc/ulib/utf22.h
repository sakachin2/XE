...
//v7ac:240229 (WINCON)on Windows Console,Font Mincho, confused ambiguous char display when /Yv; try write ambiguous char 1 by 1//~v7acI~//~vbzMR~
...
#define UCSDDID_AMBDBCS     9    //width==2 ,ambiguous             //~v7acI~
