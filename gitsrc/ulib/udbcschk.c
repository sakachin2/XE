...
//**************************************************
//v7aa:240228 support native wcstombs                              //~v7aaI~
...
//v7a2:240222 Assetion faile at msvs when /c<codepage> failed      //~v7a2I~
...
UTRACEP("%s:DBCSCHK_LOCALE1 width=%d\n",UTT,width);                       //~v62UR~//~v7aaR~
//          ucs=wc;                                                //~v61bI~//~v6BkR~
            ucs=(ULONG)wc;                                         //~v6BkI~
            switch (width)                                         //~v61bI~
            {                                                      //~v61bI~
...
UTRACEP("%s:rc=%d,%02x%02x,ucs=%04x\n",UTT,rc,*Pstr,(Plen>1?*(Pstr+1):0),ulucs);//~v5n1R~//~v7aaR~
    return rc;                                                     //~v5mQI~
...
//  memset(Ppdbcs,0,Plen);                                         //~v62UR~//~v6BkR~
  ...
  UTRACEP("usetdbcstblmb opt=%x,udbcschk_flag=%x,rc=%x\n",Popt,Gudbcschk_flag,rc);//~v62UR~//~v6k0R~//~v7a2R~
  UTRACED("usetdbcstblmb in  data",Ppdata,Plen);                     //~v62UR~//~v6k0R~//~v7a2R~
  UTRACED("usetdbcstblmb out dbcstbl",Ppdbcs,Plen);                  //~v62UR~//~v6k0R~//~v7a2R~
    return rc;                                                     //~v5n8I~
}//usetdbcstblmb                                                   //~v5n8I~
#endif	//WCSUPP                                                   //~v5n8I~
#ifdef UTF8SUPPH                                                   //~v627I~
...
//  	        	uerrmsg("Warning:setlocale failed for (%s),but charset is used as converter",0,//~v6C5I~//~v7a2R~
//  		                Plocale);                              //~v633I~//~v7a2R~
//  	        	sprintf(wkerrmsg,"Warning:setlocale failed for (%s) errno=%d,but charset is used as converter",Plocale,errno);//~v7a2R~
//  	        	printf(wkerrmsg);                              //~v7a2R~
    	        	uerrmsg("Warning:setlocale failed for (%s),errno=%d,but charset is used as converter",0,//~v7a2I~
    		                Plocale,errno);                        //~v7a2I~
#endif                                                             //~v6faR~
...
//******************                                               //~v6BAI~
#ifdef W32                                                         //~v7aaR~
  	if (Popt & UW2MWO_NATIVE)      //No supportof NOBESTFIT        //~v7aaR~
  	{                                                              //~v7aaR~
    	UCS4_TO_UTF16(Pucs,uwch,&ucs2ctr);                         //~v7aaR~
        uwch[ucs2ctr]=0;                                           //~v7aaR~
    	rc=wcstombs(wkmbs,uwch,sizeof(wkmbs));                     //~v7aaR~
    	UTRACEP("%s:Native rc=%d\n",UTT,rc);                       //~v7aaR~
    	UTRACED("ucs2",uwch,ucs2ctr*sizeof(UWCHART));              //~v7aaI~
	    UTRACED("mb",wkmbs,rc>0?rc:0);                             //~v7aaR~
    	return rc;                                                 //~v7aaR~
    }                                                              //~v7aaR~
#endif                                                             //~v7aaR~
  if (Popt & UW2MWO_NOBESTFIT) //        0x01                      //~v6C5I~
	...
	opt=UCVUCS_BESTFIT/*to match with wctomb*/|UCVUCS_SETSUBCHRC/*to get errrepflag!=0*/;//~v6BAR~
  	...
  	if (Popt & UW2MWO_NOREVERSECHK)                                //~v7a3I~
		opt|=UCVUCS_ERRSTOP; 	//no revesechk                     //~v7a3I~
