...
#define UVIOSCDLO_CLEAR      0x01         //clear                  //~vbzJI~
#endif                                                             //~v7bhI~
#ifdef AAA                                                         //~vbzJI~
int uvioSaveCellDataLocalefile(int Popt,UCHAR *Ppdata,int Plen,int Prow,int Pcol);//~vbzJM~
#endif                                                             //~vbzJI~
int uvioSaveCellDataDD(int Popt,UCHAR *Ppdata,UCHAR *Ppdbcs,int Plen,WUCS *Ppucs,int Pucsctr,int Prow,int Pcol);//~v7bhR~
#endif //WINCON                                                    //~vbzJI~
#endif                                                             //~vbzJI~
#ifdef WXE                                                         //~vbzMM~
