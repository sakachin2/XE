...
//v7dP:241109 ccsid-1140(cp037+Euro) support by "SBCS_CHARSET DefaulMapEuro"(1027/290 is already ebc-E1->20ac)//~v7duI~
//v7du:241019 accept ucs2 for E2A by Uxxxx                         //~v7duI~
//v7dt:241019 deprecate s3270 ebc conv, so del A2F/F2A option      //~v7dtI~
//v7dn:241007 following v7dk, delete cp037 and use DefaultMap only //~v7dnI~
//v7dm:241006 delete EBC2ASC_BASE option, then use the value as SBCS037_NODBCS for CP037 without DBCS//~v7dmI~
...
#ifdef W32                                                         //~v7dhI~
#define ICU_DATADIR_DEFAULT_WINDOWS "c:\\Windows\\Globalization\\ICU"//~v7dhR~
#endif                                                             //~v7dhI~
#ifdef WCSUPP
//******************************************************           //~v5n8I~
...
//#define  UCECF2_BASE           0x00000020      //SJISOPT=Base for DBCS=CP300//~v7d5R~//~v7dmR~
#define  UCECF2_CP931          0x00000040      //SJISOPT=LATIN for DBCS=CP300//~vbB9I~
#define  UCECF2_SJISOPT_CP     0x00000080      //SJISOPT=KANA or ENG or LATIN//~v7dcI~
//#define  UCECF2_CP037          0x00000100      //CONVERTER=0 and SBCSCHARSET=CP037, difference width DefaultMap is CP037-Internal on DBCSJ env//~v7dcR~//~v7dhR~//~v7dnR~
#define  UCECF2_CP037_EURO     0x00000100      //ebc9f->20ac(euro) <== 00a4//~v7dPR~
...
#endif //BBB                                                       //~v7dtI~
					USHORT UCECsbcsmape2u[256];  //by MAP_E2A      //~v7duI~
...
#define MISC_EBCEOLZ 0x0100 //accept 0d015 as eol                  //~vbBuI~
//******************************************************
...
void ucvext_notifyTables();                                        //+v7dUI~
