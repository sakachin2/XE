...
//      if (rc!=UFGETS_RCBIN)//notify determind binary             //~v661I~//~v68kR~
    ...
    if (Peolid)                                                    //~v090I~
            *Peolid=eolid;                                             //~v090I~
    UTRACEP("%s:*Preadlen=%d,eolid=%02x\n",UTT,*Preadlen,eolid);   //~vbBuI~
...
//        	datalen=(ULPTR)pc-(ULPTR)Siobpos;                      //~v6hhI~//~v6BxR~
        	...
        	Siobpos=pc+1;                                          //~v68hI~
            if (datalen && *(pc-1)==CRID)   //cr+lf                //~vbBuI~
            {                                                      //~vbBuI~
				if (Smode & UFGETS_EBCEOLZ) //allow 0x0d15 as EOLDID//~vbBuI~
                {                                                  //~vbBuI~
                	datalen--;                                     //~vbBuI~
                	*Peolid=UFGETS_EOLID_EBCZ;  		//0d15     //~vbBuR~
                }                                                  //~vbBuI~
        	}                                                      //~vbBuI~
    	}//cr found                                                //~v68hI~
   }//EBCEOL                                                       //~v68hR~
...
//}                                                                //~v77bR~
//********************************************************************//~4B29I~//~vbByM~
//*readlen:len excluding EOLID                                     //~4B29I~//~vbByM~
//*eolid:1(LF only)/2(crlf)/0(no eolid)                            //~4B29I~//~vbByM~
//********************************************************************//~4B29I~//~vbByM~
int ufgetline(int Popt,FILE *Pfh,char *Pbuff,int Pbuffsz,int *Ppreadlen,int *Ppeolid)//~4B29I~//~vbByM~
{                                                                  //~4B29I~//~vbByM~
    int rc,eolid=0,readlen=0;                                      //~4B29R~//~vbByM~
    UTRACEP("%s:opt=%02x,buffsz=%d\n",UTT,Popt,Pbuffsz);           //~4B29I~//~vbByM~
    char *pc=fgets(Pbuff,Pbuffsz,Pfh);                             //~4B29R~//~vbByM~
    rc=errno;                                                      //~4B29I~//~vbByM~
    if (!pc)                                                       //~4B29I~//~vbByM~
    {                                                              //~4B29I~//~vbByM~
        if (feof(Pfh))                                             //~4B29R~//~vbByM~
            rc=UFGLRC_EOF;                                         //~4B29I~//~vbByM~
    }                                                              //~4B29I~//~vbByM~
    else                                                           //~4B29I~//~vbByM~
    {                                                              //~4B29I~//~vbByM~
        rc=0;                                                      //~4B29I~//~vbByM~
        readlen=(int)strlen(Pbuff);                                //~4B29I~//~vbByM~
        if (readlen)                                               //~4B29I~//~vbByM~
        {                                                          //~4B29I~//~vbByM~
            if (*(Pbuff+readlen-1)=='\n')                          //~4B29I~//~vbByM~
            {                                                      //~4B29I~//~vbByM~
                readlen--;                                         //~4B29I~//~vbByM~
                if (readlen && *(Pbuff+readlen-1)=='\r')           //~4B29I~//~vbByM~
                {                                                  //~4B29I~//~vbByM~
                    eolid=UFGLEOL_CRLF;	//2                        //~4B29I~//~vbByM~
                    if (!(Popt & UFGLO_LFONLY))//not return cr included//~4B29I~//~vbByM~
                        readlen--;                                 //~4B29I~//~vbByM~
                    else                                           //~4B29I~//~vbByM~
                        eolid=UFGLEOL_OPTLF; // 0x03  //crlf but remains cr by option//~4B29I~//~vbByM~
                }                                                  //~4B29I~//~vbByM~
                else                                               //~4B29I~//~vbByM~
                {                                                  //~4B29I~//~vbByM~
                    eolid=UFGLEOL_LF;	//1                        //~4B29I~//~vbByM~
                }                                                  //~4B29I~//~vbByM~
            }                                                      //~4B29I~//~vbByM~
        }                                                          //~4B29I~//~vbByM~
    }                                                              //~4B29I~//~vbByM~
    UTRACEP("%s:rc=%d,readlen=%d,eolid=%d\n",UTT,rc,readlen,eolid);//~4B29I~//~vbByM~
    UTRACED("Pbuff",Pbuff,(int)readlen);                           //~4B29I~//~vbByM~
    if (Ppreadlen)                                                 //+vbByI~
    	*Ppreadlen=readlen;                                            //~4B29I~//+vbByR~
    if (Ppeolid)                                                   //+vbByI~
	    *Ppeolid=eolid;                                                //~4B29I~//+vbByR~
    return rc;                                                     //~4B29I~//~vbByM~
}//ufgetline                                                       //~4B29I~//~vbByM~
