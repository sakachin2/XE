...
int bc_surrogate(UCHAR *Pout,long *Pvalue);                        //~v7asI~
//****************************************************************
// calc body
//*rc   :0
//****************************************************************
...
//        }                                                        //~v56vR~
    ...
    case 'L':     //convert TOD                                    //~v50jR~
        if (bc_edittod(rval,lvt1))                                 //~v50tR~
        	return 4;                                              //~v50tI~
    	break;                                                     //~v50fI~
    case 'S':     //convert TOD                                    //~v7asI~
        if (bc_surrogate(rval,lvt1))                               //~v7asI~
        	return 4;                                              //~v7asI~
    	break;                                                     //~v7asI~
...
//***************************************************************  //~v7asI~
//*edit dword value                                                //~v7asI~
//parm1:conv type                                                  //~v7asI~
//parm2:3 word                                                     //~v7asI~
//parm3:edit out area                                              //~v7asI~
//*rc:4:err                                                        //~v7asI~
//***************************************************************  //~v7asI~
int bc_surrogate(UCHAR *Pout,long *Pvalue)                         //~v7asI~
{                                                                  //~v7asI~
    ULONG ucs4;                                                    //~v7asI~
    UINT high,low;                                                 //~v7asI~
    USHORT highlow[2];                                             //~v7asI~
    int ctr;                                                       //~v7asI~
//*****************                                                //~v7asI~
    ucs4=(ULONG)Pvalue[0];                                         //~v7asI~
    high=(UINT)(ucs4 >>16);                                        //~v7asR~
    low=ucs4 & 0xffff;                                             //~v7asR~
    if (IS_UTF16_PAIR(high,low))                                   //~v7asI~
    	ucs4=UTF16_TO_UCS4(high,low);                              //~v7asI~
    else                                                           //~v7asI~
    {                                                              //~v7asI~
    	UCS4_TO_UTF16(ucs4,highlow,&ctr);                          //~v7asI~
        if (ctr==1)                                                //~v7asI~
        	ucs4=highlow[0];                                       //~v7asI~
        else                                                       //~v7asI~
        	ucs4=highlow[0]<<16|highlow[1];                        //~v7asI~
    }                                                              //~v7asI~
	sprintf(Pout,"%08x",(UINT)ucs4);                               //~v7asR~
    return 0;                                                      //~v7asI~
}//bc_edittod                                                      //~v7asI~
