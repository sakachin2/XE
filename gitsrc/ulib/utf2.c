...
//v7a4:240225 cv mb to ucs was missing.                            //~v77BI~
...
//#ifdef AAA //no user,using UWCHART                                 //~v6uBI~//~v77BR~
//*************************************************************    //~v645I~
...
#endif                                                             //~v7a5I~
//**********************                                           //~v645I~
	repch=(char)((Popt & UTFCVO_REPCH)>>8);                                //~v645I~//~v7a5R~
    maxucs=Poutbuffsz/(int)sizeof(WUCS);                                //~v645I~//~v7a5R~
...
//    	chklen=utfcvl2uany1mb(0,pc,reslen,&ucs,NULL/*rc*/);  //ucvext_iconvlocal2ucs(iconv/wincolocal2ucs)//~v6unI~//~v7a4R~
      	chklen=utfcvl2uany1mb(0,pc,reslen,&ucs4,NULL/*rc*/);  //ucvext_iconvlocal2ucs(iconv/wincolocal2ucs)//~v7a4R~
        ...
        {                                                          //~v645I~
            if (Poutbuff)                                          //~v645I~
            {                                                      //~v7a4I~
//      		*pwucs++=ucs;                                      //~v645R~//~v7a4R~
#ifdef W32                                                         //~v7a4M~
	        	UCS4_TO_UTF16(ucs4,pwucs,&ucs2sz);                 //~v7a4R~
                pwucs+=ucs2sz;                                     //~v7a4I~
#else                                                              //~v7a4I~
        		*pwucs++=ucs4;                                     //~v7a4R~
#endif                                                             //~v7a4I~
...
//  readlen=(int)((ULONG)pc-(ULONG)Pinp);                          //~v645I~//~v6b9R~
	outlen=ucsctr*(int)sizeof(WUCS);                                    //~v645R~//~v7a5R~
    if (Popt & UTFCVO_ERRRET)  //return if err                     //+v7ajI~
        if (ucsctr<maxucs)                                         //+v7ajI~
            *pwucs=0;                                              //+v7ajI~
    if (Ppoutlen)                                                  //~v645I~
	    *Ppoutlen=outlen;                                          //~v645I~
	if (Popt & UTFCVO_ASCIIRET)//        0x02      //return if ascii detected//~v7a5I~
	    if (asciisw && !rc)                                            //~v645I~//~v7a5R~
    		rc=UTFCVRC_ALLASCII;                                       //~v645I~//~v7a5R~
UTRACEP("%s:rc=%d chklen=%d,outlen=%d\n",UTT,rc,/*readlen*/(int)((ULPTR)pc-(ULPTR)Pinp),outlen);   //~v645R~//~v6b9R~//~v6hhR~//~v7a5R~
...
//#endif //AAA //no user,using UWCHART                               //~v6uBI~//~v77BR~
#endif                                                             //~v645I~
#endif  //WCSUPP                                                   //~v5ncI~
#ifdef W32                                                         //~v7a5I~
//**************************************************************************************//~v7a5I~
//*ucs2 to local using uwctomb                                     //~v7a5I~
//**************************************************************************************//~v7a5I~
...
{                                                                  //~v7a5I~
	int   rc=0,repch,reslen,outreslen,mblen,repctr=0;              //~v7a5R~
    UCHAR *pmb,wkmb[8];                                            //~v7a5I~
    UWCHART *pwucs,ucs2;                                           //~v7a5I~
//****************************************                         //~v7a5I~
    UTRACED("inp",Pibuff,Pinpctr*sizeof(UWCHART));                 //~v7a5R~
    repch=(int)(Popt & UCVUCS_ERRCH);                              //~v7a5I~
    if (!repch)                                                    //~v7a5I~
    	repch='?';                                                 //~v7a5I~
    for (reslen=Pinpctr,pwucs=Pibuff,outreslen=Pobufflen,pmb=Pobuff;reslen>0;)//~v7a5R~
    {                                                              //~v7a5I~
    	ucs2=*pwucs;                                               //~v7a5I~
		mblen=uwctombW(0,(UWUCS)ucs2,wkmb);                        //~v7a5I~
        if (mblen<=0)                                              //~v7a5I~
        {                                                          //~v7a5I~
        	if (Popt & UTFCVO_ERRRET)  //return if err             //~v7a5I~
            {                                                      //~v7a5I~
            	rc=UTFCVRC_ERRSTOP;     //8                        //~v7a5I~
            	break;                                             //~v7a5I~
            }                                                      //~v7a5I~
            mblen=1;                                               //~v7a5I~
            wkmb[0]=(UCHAR)repch;                                  //~v7a5R~
            rc|=UCVUCS_CONVERR;                                    //~v7a5I~
            repctr++;                                              //~v7a5I~
        }                                                          //~v7a5I~
        outreslen-=mblen;                                          //~v7a5I~
        if (outreslen<0)                                           //~v7a5I~
        {                                                          //~v7a5I~
	        rc|=UCVUCS_BUFFOVF;                                    //~v7a5I~
            break;                                                 //~v7a5I~
        }                                                          //~v7a5I~
        memcpy(pmb,wkmb,(UINT)mblen);                              //~v7a5I~
        pmb+=mblen;                                                //~v7a5I~
        reslen--;                                                  //~v7a5R~
        pwucs++;                                                   //~v7a5I~
    }                                                              //~v7a5I~
	if (Popt & UTFCVO_STRZ && outreslen>0)                         //~v7a5R~
    	*pmb++=0;	                                               //~v7a5I~
    int chkctr=Pinpctr-reslen;                                     //~v7a5I~
    if (Ppchkctr)                                                  //~v7a5R~
    	*Ppchkctr=chkctr;                                          //~v7a5R~
    int outlen=Pobufflen-outreslen;                                //~v7a5I~
    if (Ppoutlen)                                                  //~v7a5R~
	    *Ppoutlen=outlen;                                          //~v7a5R~
    if (Pprepctr)                                                  //~v7a5R~
	    *Pprepctr=repctr;                                          //~v7a5R~
	UTRACEP("%s:rc=%d,opt=%x,chkctr=%d,outlen=%d,repctr=%d\n",UTT,rc,Popt,chkctr,outlen,repctr);//~v7a5R~
	UTRACED("outmb",Pobuff,outlen);                                //~v7a5R~
    return rc;                                                     //~v7a5I~
}//utfcvu2lmb                                                      //~v7a5I~
#endif //W32                                                       //~v7a5I~
