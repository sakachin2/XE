...
//*  umemtrim                                                      //~v5mpI~
//*************************************************************
//v7c5:240620 add ustrnspnc, it use strspn and suppors null char length//~v6H3I~
...
//******************************************************           //~v7c5R~
//*get char length                                                 //~v7c5R~
//*for not null char, use strspn for performance                   //~v7c5R~
//******************************************************           //~v7c5R~
size_t ustrnspnc(char *Pbuff,char Pchr,unsigned int Plen)          //~v7c5R~
{                                                                  //~v7c5R~
    char srch[2];                                                  //~v7c5R~
    size_t spn;                                                    //~v7c5R~
	if (Pchr)                                                      //~v7c5R~
    ...
    {                                                              //~v7c5R~
    	spn=umemspnc(Pbuff,0,Plen);                                //~v7c5R~
    }                                                              //~v7c5R~
    return spn;                                                    //~v7c5R~
}//ustrnspnc                                                       //~v7c5R~
//*******************************************************          //~v6hDI~
