...
//  utempnam("","xetmpstdo_",tempfnm[0]);                          //~v5csR~
  ...
  if (Popt & UPROC_STDE2O)  //redirect stderr to stdout            //~v7deI~
    *tempfnm[1]=0;                                                 //~v5csI~
  else                                                             //~v7deI~
    utempnam("","xetmpfstde",tempfnm[1]);                          //~v7deI~
  if (Popt & UPROC_STDE2O)  //redirect stderr to stdout            //~v61pI~
...
//      len=(rctr[ii]+1)*4+rsz[ii];	//ptrlist(last null) and record area//~v50GI~//~v690R~
        ...
        UTRACEP("%s:ii=%d,ctr=%d,len=%d,ptr=%p\n",UTT,ii,rctr[ii]+1,len,stg[ii]);//~v6qaR~//~vc70R~
        if (!stg[ii])                                              //~v50GI~
        	break;                                                 //~v50GI~
        stg[ii][0]=0;                                              //~v5csI~
...
//read record to buffer                                            //~v50GI~
    ...
    {                                                              //~v50GI~
        ...
        {                                                          //~v50GI~
            ...
            *(pc+len++)=0;                                         //~v50GI~
        	UTRACEP("%s:ii=%d,jj=%d,len=%d,ptr=%p\n",UTT,ii,jj,len,pc);//~v6qaI~//~vc70R~
        	UTRACED("pc",pc,len);                //~v6qaI~         //~vc70R~
            pc+=len;                                               //~v50GI~
        }                                                          //~v50GI~
        fclose(fh);                                                //~v50GI~
