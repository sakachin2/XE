...
//*******                                                          //~v69cI~
    ...
    UTRACEP("ucvebc4_getcvtype handle=%d, rc=%x\n",Phandle,cvtype);//~v6bdI~
    return cvtype;                                                 //~v69cI~
...
//*******                                                          //~v69cI~
    ...
    UTRACEP("ucvebc4_create_handle gethandle rc=%d cvname=%s\n",rc,Pcvname);//~v6bdI~
    if (rc>1)	                                                   //~v69cI~
    	return rc;                                                 //~v69cI~
...
//*******                                                          //~v69cI~
    ...
    *Ppopt=opt;                                                    //~v69cI~
UTRACEP("ucvebc4_getparmconverter cvdbcs=%x,cvsbcs=%x,mapsbcs=%x,mapsbcsc=%x\n",cvdbcs,cvsbcs,mapsbcs,mapsbcsc);//~v69cR~
    return 0;                                                      //~v69cI~
...
//      pmapc=(UCHAR*)Spcve2a[CONVERTER_SBCSMAPC];                 //~v69cR~
        UTRACEP("ebc4b2uSbcs1 opt=%x ebc1=%02x\n",Popt,*Ppebc);    //~v6hhR~
...
//  }                                                              //~v69cR~
    *Ppucs=wucs;
    UTRACEP("ucvebc4_b2uSbcs1 rc=%x,in=%02x,outucs=%x\n",rc,*Ppebc,wucs);//~v6hhR~
    return rc;
...
//  mblen=(ULPTR)pco-(ULPTR)Poutbuff;                              //~v6hhI~//~v6BkR~
    ...
    if (Ppmblen)
    	*Ppmblen=mblen;
UTRACED("ucvebc3 b2m sbcs output data",Poutbuff,mblen);
UTRACED("ucvebc3 b2m sbcs output dbcs",Poutdbcs,mblen);            //~v68bR~
    return rc;
...
//      }                                                          //~v69cR~
    	UTRACEP("ucvebc4_setupsubch icu getconvertersubch ebcsbcs=%02x,ebcdbcs=%02x%02x,len=%d,ucssbcs=%x,ucsdbcs=%x\n",//~v69cR~//~v6bkR~
				subcharICUebcSbcs,subcharICUebcDbcs[0],subcharICUebcDbcs[1],subcharICUebcDbcslen,subcharsbcs,subchardbcs);//~v69cR~
    }//USE_ICU                                                     //~v66DI~
#ifdef W32                                                         //~v66NI~
    else                                                           //~v66NI~
    {                                                              //~v66NI~
...
//      {                                                          //~v69cR~
        ...
        UTRACEP("ucvebc4_setupsubch dbcs ebc chk ucs=%04x,rc=%d\n",ucs,rc2);//~v6bkR~
        UTRACED("ucvebc4_setupsubch dbcs ebc ",mbstr,mblen);       //~v6bkR~
...
//  if (!UDBCSCHK_ISDBCSCV())                                      //~v69cR~
    ...
    UTRACEP("ucvebc4_setupsubch getconvertersubch sbcs=%02x,dbcs=%02x%02x,len=%d,\n",//~v69cR~//~v6bkR~
            subcharebcsbcs,subcharebcdbcs[0],subcharebcdbcs[1],subcharebcdbcslen);//~v69cR~
