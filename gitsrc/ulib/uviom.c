...
//    }                                                            //~v7acR~
//#endif                                                           //~v7acR~
    UTRACEP("%s:posx=%d,posy=%d,ucs[0]=%04x\n",UTT,Ptgtpos.X,Ptgtpos.Y,*Ppucs);//~vbzJR~
    UTRACED("Ppucs",Ppucs,ctr2szW(Plen));                          //~v6D6R~//~vbzJM~
...
//    if (ch<0x20 && noligid)                                      //~v6EaR~//~v6P0R~
  ...
  {                                                                //~v7bnI~
    ...
    if (Popt & (UVIOO_ERRMSG|UVIOO_ERRMSG2))     //        0x80/0x0400       //special for uerrmsg//~v7bnI~
	    uvioSaveCellDataDD(Popt,pdata0,Ppdbcs,Plen,pucs0,ucsctr,Ptgtrect->Top,Ptgtrect->Left);//~v7bnR~
#endif                                                             //~v7bnI~
  }                                                                //~v7bnI~
  else                                                             //~v640I~
#endif                                                             //~v640I~
...
//  			rc+=uviom_displaydbcspadCharacterW(0,tgtpos,padctr-1);//~v6XbR~//~v7a1R~
              ...
              {                                                    //~vbzJI~
    			...
    			rc+=uviom_displaydbcspadCharacterW(0,tgtpos,padctr);//~v7a1I~
              }                                                    //~vbzJI~
...
//***********************                                          //~v6VgI~
    ...
    {                                                              //~v6VgI~
        ...
        int ucs4;                                                  //~v7c4I~
		if (Plen==2)                                               //~v7c4I~
			ucs4=UTF16_TO_UCS4(*Ppucs,*(Ppucs+1));                 //~v7c4I~
        else                                                       //~v7c4I~
        	ucs4=*Ppucs;                                           //~v7c4I~
