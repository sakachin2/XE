...
//***********************                                          //~v6VgI~
	UTRACEP("%s:len=%d,X=%d,Y=%d,Gutfcombaltch=%04x,Sposcvhex=%d,Ppattr=%p,*Ppattr=%04x\n",UTT,Plen,Ptgtpos.X,Ptgtpos.Y,Gutfcombaltch,Sposcvhex,Ppattr,*Ppattr);//~v7ejR~
...
//***********************                                          //~v6WuI~
	...
	UTRACED("write attr",wkattr,len*sizeof(wkattr[0]));            //~v7e4R~
