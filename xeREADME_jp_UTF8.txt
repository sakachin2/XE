||*CID:||+v@@@R~:  2020/10/28                update#=  815;           ||+v@@@R~
######################################################################
[Japanese]    v1.29Q                                                  ||+v@@@R~
     ...
     3.その他                                                         ||~129MR~
       -Manjaro Linux 対応                                            ||~129MR~
        ...
        .ncursesw フォルダーが提供されない(libncurseswは存在する)     ||~129MI~
                                                                      ||~129MR~
  .v129Q<--129N:(2020/12/16)                                          ||+v@@@I~
                                                                      ||+v@@@I~
     1.BUGs                                                           ||+v@@@I~
       -(gxe) IME入力処理が常に同じ文字を出力していた                 ||+v@@@I~
                                                                   //~@@@1I~||+v@@@I~
     3.その他                                                      //~@@@1R~||+v@@@I~
       -(wxe) 3rd party IME による システムのロケールに変換できない文字コードの入力に対応||+v@@@I~
       -/Nmコマンドラインスイッチの機能変更(A+u を絡ませた)           ||+v@@@I~
		  コマンドラインスイッチ/Nmを指定した場合はCPLC(UTF8でない)ファイルに||+v@@@I~
          Alt+u ON(コマンド入力行に =u=> を表示)のときはUTF8コードをセット、||+v@@@I~
		  A+u OFF(===>)のとき変換エラー文字は時は"?"を                ||+v@@@I~
          変換できた時はローケールコードをセットする。                ||+v@@@I~
