...
######################################################################
  ...
  .v129N<--129M:(2020/09/23)                                          ||~129MI~
                                                                      ||~129MI~
     1.BUGs                                                           ||~129MI~
       -3バイト(EUC 8fxxyy),4バイト(GB18030) DBCSでコマンド行のカーソル位置付けを誤る//+@@@1R~||~129MI~
       -結合文字（文字幅=0)が表示されないことがある                //+@@@1R~||~129MI~
       -"OPT unicomb comb" コマンドと "UTF file" コマンドのフラグ操作がバッティングしていた//+@@@1I~||~129MI~
       -(Linux) directory list の "a"(Attrib) 行コマンド で クラッシュすることがある//+@@@1I~||~129MI~
                                                                   //~@@@1I~||~129MI~
     2.機能追加                                                    //~@@@1R~||~129MI~
                                                                   //~@@@1I~||~129MI~
     3.その他                                                      //~@@@1R~||~129MI~
       -Axe(Android版) 対応                                        //+@@@1R~||~129MI~
       -Windows console版で grep などの外部コマンド呼び出しが応答なしになることがある。//+@@@1I~||~129MI~
        それを検知したら警告を出す。                               //+@@@1I~||~129MI~
                                                                   //~@@@1I~||~129MI~
     4.ツール。                                                       ||~v129R~//~@@@1R~||~129MI~
                                                                      ||~129MI~
